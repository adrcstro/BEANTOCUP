...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="mb-4">';
            echo '<h2 class="card-title">BEANtoCUP <i class="bi bi-cup-hot-fill"></i></h2>';
            echo '<p><strong>Address:</strong> 123 Main St, Cityville</p>';
            echo '<p><strong>Contact:</strong> (123) 456-7890</p>';
            echo '</div>';
                        
            // Order Information
            echo '<h3 class="card-title">Order Receipt</h3>';
            ...
            // Ordered Items
            echo '<h3 class="card-title">Ordered Items</h3>';
            ...
            // Billing Information
            echo '<h3 class="card-title">Billing Information</h3>';
