...
if (isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="row">';
            echo '<div class="col text-center"><p><strong>Address:</strong> 123 Main St, Cityville</p></div>';
            echo '<div class="col text-center"><p><strong>Contact:</strong> (123) 456-7890</p></div>';
            echo '</div>';
            echo '</div>';
