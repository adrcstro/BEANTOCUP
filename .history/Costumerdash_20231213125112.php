...
<div class="table-responsive">
                    ...
                    <button style="border-color: #E48F45; " type="button" class="btn  btn-sm m-1" data-toggle="modal" data-target="#Admin">
    <i class="bi bi-plus-circle"></i> View Menu
</button>


<button style="border-color: #E48F45;" type="button" class="btn  btn-sm m-1" data-toggle="modal" data-target="#update">
    <i class="bi bi-pencil"></i> View News
</button>
