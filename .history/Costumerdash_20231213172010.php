    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<button class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Add to Cart</button>';
                echo '<button class="btn btn-success"><i class="fas fa-shopping-bag"></i> Buy Now</button>';
                echo '</div>';
