    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<button class="btn btn-primary btn-sm mr-1"><i class="fas fa-shopping-cart"></i></button>'; // Added margin class (mr-1)
                echo '<button class="btn btn-success btn-sm mr-1"><i class="fas fa-shopping-bag"></i></button>';
                echo '</div>';
