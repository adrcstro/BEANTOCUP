    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<button class="btn btn-primary btn-sm btn-sm-custom mr-1"><i class="fas fa-shopping-cart"></i></button>'; // Added custom class btn-sm-custom
                echo '<button class="btn btn-success btn-sm btn-sm-custom mr-1"><i class="fas fa-shopping-bag"></i></button>';
                echo '</div>';
