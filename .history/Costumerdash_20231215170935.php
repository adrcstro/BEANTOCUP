...
<div class="menu-btns">
      <button type="button" class="menu-btn active-btn" data-toggle="modal"  data-target="#featured" id="featured"><i class="fa-solid fa-mug-hot"></i></i>Hot Coffee's</button>
  ...
  <div class="modal fade" id="featured">
    <div class="modal-dialog">
        <div class="modal-content">
