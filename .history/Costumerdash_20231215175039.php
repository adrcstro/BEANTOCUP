...
<div class="menu-btns">
      <button type="button" class="menu-btn active-btn" data-toggle="modal"  data-target="#hotcoffees" id="featured"><i class="fa-solid fa-mug-hot"></i></i>Hot Coffee's</button>
...
if(isset($_POST['searchTerm']) && !empty($_POST['searchTerm'])) {
    ...
    // If no search term, fetch data for specific MenuIDs
    $query = "SELECT MenuID, Name, Price, Body, Image FROM menu WHERE MenuID IN (14, 15, 16, 17, 18, 19)";
}
...
?>
            ...
            <button id="btnhover" style="border-color: #E48F45;"  type="button" class="btn  btn-sm m-1">
