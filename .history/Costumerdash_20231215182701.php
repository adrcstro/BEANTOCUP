...
<div class="container">
  <div class="row menu-btns">
    <div class="col-md-6 col-lg-4">
      <button type="button" class="btn btn-primary menu-btn" data-toggle="modal" data-target="#hotcoffees" id="featured">
        <i class="fa-solid fa-mug-hot"></i> Hot Coffee's
      </button>
    </div>
    <div class="col-md-6 col-lg-4">
      <button type="button" class="btn btn-primary menu-btn" data-toggle="modal" data-target="#Pastries" id="today-special">
        <i class="fa-solid fa-cake-candles"></i> Pastries
      </button>
    </div>
    <div class="col-md-6 col-lg-4">
      <button type="button" class="btn btn-primary menu-btn" data-toggle="modal" data-target="#IceCoffees" id="new-arrival">
        <i class="fa-solid fa-mug-saucer"></i> Ice Coffee's
      </button>
    </div>
    <div class="col-md-6 col-lg-4">
      <button type="button" class="btn btn-primary menu-btn" data-toggle="modal" data-target="#BlendedCoffees" id="Blended-Coffee">
        <i class="fa-solid fa-blender"></i> Blended Coffee's
      </button>
    </div>
    <div class="col-md-6 col-lg-4">
      <button type="button" class="btn btn-primary menu-btn" id="Hot-tea">
        <i class="fa-brands fa-envira"></i> Hot Tea's
      </button>
    </div>
  </div>
</div>
...
?>
            ...
            <button id="btnhover" style="border-color: #E48F45;" data-dismiss="modal" data-toggle="modal"  data-target="#Pastries"   type="button" class="btn  btn-sm m-1">
            <i class="bi bi-arrow-90deg-left"></i> Back</button>
            <button id="btnhover" style="border-color: #E48F45;" data-dismiss="modal" type="button" class="btn  btn-sm m-1">
            <i class="bi bi-arrow-90deg-right"></i> Next</button>
            </div>
...
<div class="card-header d-flex justify-content-between align-items-center">
    ...
    <button class="btn btn-outline-secondary custom-width-btn" type="button" id="button-addon2">
