...
$query = "SELECT MenuID, Name, Price, Body, Image FROM menu WHERE MenuID IN (38, 39,40, 41, 42, 43) AND (MenuID LIKE '%$searchTerm%' OR Name LIKE '%$searchTerm%' OR Price LIKE '%$searchTerm%' OR Body LIKE '%$searchTerm%' OR Image LIKE '%$searchTerm%')";
