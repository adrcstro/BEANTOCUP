...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<button data-toggle="modal"  data-target="#BuyNowModal" class="btn btn  btn-sm-custom mr-1"><i class="fas fa-shopping-bag"></i></button>';
        echo '</div>';
...
<div class="modal fade" id="BuyNowModal<?php echo $row['MenuID']; ?>" tabindex="-1" role="dialog" aria-labelledby="BuyNowModalLabel<?php echo $row['MenuID']; ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="BuyNowModalLabel<?php echo $row['MenuID']; ?>">Product Details - <?php echo $row['Name']; ?></h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menuID" value="<?php echo $row['MenuID']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="productName">Product Name:</label>
                        <input type="text" class="form-control" id="productName" value="<?php echo $row['Name']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="productPrice">Price:</label>
                        <input type="text" class="form-control" id="productPrice" value="<?php echo $row['Price']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="productBody">Description:</label>
                        <textarea class="form-control" id="productBody" readonly><?php echo $row['Body']; ?></textarea>
                    </div>
                    <div class="form-group">
