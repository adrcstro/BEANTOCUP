...
echo '<button data-toggle="modal" data-target="#BuyNow" data-menuid="' . $MEnuID . '" data-name="' . $header . '" data-price="' . $date . '" data-body="' . $body . '" data-image="' . $image . '" class="btn btn btn-sm-custom mr-1"><i class="fas fa-shopping-bag"></i></button>';
...
<div class="modal fade" id="BuyNow">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div style="background-color: #E48F45;" class="modal-header">
                <h4 style="color: #fff;" class="modal-title" id="buyNowModalLabel">Item Details</h4>
                <button style="background-color: #E48F45; color: #fff;" type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
                <div id="buyNowContent">
                    <!-- Display fetched data dynamically here -->
                </div>
            </div>
...
<script>
    // Update the modal content when the modal is shown
    $('#BuyNow').on('show.bs.modal', function (event) {
        ...
        modal.find('#buyNowContent').html('<p>MenuID: ' + menuID + '</p>' +
                                           '<p>Price: ' + price + '</p>' +
                                           '<p>Body: ' + body + '</p>' +
                                           '<img src="uploads/' + image + '" alt="Item Image" class="img-fluid">');
    });
</script>
