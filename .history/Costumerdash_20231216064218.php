...
<div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="container mt-5 mb-5">
        ...
        echo '<button class="btn btn-primary btn-sm"><i class="fas fa-shopping-cart"></i></button>';
        echo '<button class="btn btn-success btn-sm"><i class="fas fa-shopping-bag"></i></button>';
        echo '</div>';
