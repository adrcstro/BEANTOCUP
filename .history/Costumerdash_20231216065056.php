...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<button data-toggle="modal"  data-target="#BuyNow" class="btn btn  btn-sm-custom mr-1"><i class="fas fa-shopping-bag"></i></button>';
        echo '</div>';
        ...
        // Modal for full text
        echo '<div style="background-color: #E48F45;" class="modal fade" id="MenureadMoreModal' . $row['MenuID'] . '" tabindex="-1" role="dialog" aria-labelledby="readMoreModalLabel' . $row['MenuID'] . '" aria-hidden="true">';
        echo '<div class="modal-dialog read-more-modal" role="document">';
        echo '<div class="modal-content">';
        echo '<div class="modal-header">';
