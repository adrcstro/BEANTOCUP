...
<!-- Modal for Read More -->
<div class="modal fade" id="MenureadMoreModal"  role="dialog" aria-labelledby="MenureadMoreModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <button type="button" class="btn btn-primary btn-sm m-1" id="trackButton" data-dismiss="modal"  data-target="#MenureadMoreModal" data-toggle="modal">
    <i class="bi bi-map"></i> Back
</button>
