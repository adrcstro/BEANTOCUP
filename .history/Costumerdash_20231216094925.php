...
echo '<button type="button" class="btn btn-primary" data-toggle="offcanvas" data-target="#BuyNowOffcanvas">
Open Offcanvas
</button>';
...
<div class="offcanvas offcanvas-right" tabindex="-1" id="BuyNowOffcanvas">
    <div class="offcanvas-header" style="background-color: #E48F45;">
        <h5 class="text-white">Hot Tea</h5>
    ...
    <div class="offcanvas-body">
        ...
        <div class="d-flex justify-content-center align-items-center mb-2">
            <h5 style="text-align: center; margin-right: 10px;">Options/Size</h5>
            <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button"
            ...
            $('#BuyNow .modal-body').html(`
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <img src="uploads/${data.Image}" alt="Item Image" style="max-width: 100%; height: auto;">
                    </div>
                </div>
            `);
