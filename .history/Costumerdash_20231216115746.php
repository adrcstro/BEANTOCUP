...
echo '<button data-bs-toggle="offcanvas" data-bs-target="#BuyNow" aria-controls="offcanvasWithBothOptions" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '"><i class="fas fa-shopping-bag"></i></button>';
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="BuyNow" aria-labelledby="offcanvasWithBothOptionsLabel">
    <div class="modal-dialog">
        <div class="modal-content">
    ...
    <h5 style="text-align: center; margin-bottom: 5px; color: #000000;">Options/Size</h5>
