...
echo '<button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#buynow" aria-controls="offcanvasWithBothOptions">Enable both scrolling & backdrop</button>';
