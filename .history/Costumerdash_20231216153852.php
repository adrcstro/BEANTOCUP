...
$loggedInUserID = $_SESSION['CostumerID '];

// Fetch data only for the logged-in user from the costumers table
$sql = "SELECT * FROM costumers WHERE CostumerID  = $loggedInUserID";
