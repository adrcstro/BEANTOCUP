...
// Assuming you have a session variable for the logged-in customer's ID
$loggedInCostumerID = $_SESSION['CostumerID'];

// Fetch data only for the logged-in customer from the costumers table
$sql = "SELECT * FROM costumers WHERE CostumerID = $loggedInCostumerID";
