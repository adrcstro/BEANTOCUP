...
// Fetch data from the costumers table based on the username and password
$sql = "SELECT Name, Email, Phone, HomeAddress FROM costumers WHERE Username = '$username' AND Password = '$password'";
