        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div  id="Passengers-table" style="display:none;" class="card shadow border-0 mb-7">
                    ...
                    <?php
// Assuming $username is already set from the login process
$username = $_POST['username']; // make sure to adjust this line based on how you retrieve the username
...
$sql = "SELECT * FROM costumers WHERE Username = '$username'";
