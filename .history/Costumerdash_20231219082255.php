...
if (isset($_SESSION['processing_user']) && $_SESSION['processing_user'] !== $loggedInUsername) {
...
// Set the current user as the processing user
$_SESSION['processing_user'] = $loggedInUsername;
...
if (mysqli_num_rows($result) > 0) {
    ...
    // Store user-specific data in the session using CostumerID as the key
    $_SESSION['user_data'][$loggedInCostumerID] = $userData;

    // Rest of your Custumerdash.php code goes here
} else {
