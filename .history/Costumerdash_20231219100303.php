...
// Check if user-specific data is already in the session
if (!isset($_SESSION['user_data']) || $_SESSION['user_data']['session_id'] !== session_id()) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Regenerate session ID to help ensure distinct session identifiers
...
echo "<p>Welcome, {$_SESSION['user_data']['Name']}!</p>";
echo "<p>CostumerID: {$_SESSION['user_data']['CostumerID']}</p>";
echo "<p>Email: {$_SESSION['user_data']['Email']}</p>";
echo "<p>Phone: {$_SESSION['user_data']['Phone']}</p>";
echo "<p>Home Address: {$_SESSION['user_data']['HomeAddress']}</p>";
