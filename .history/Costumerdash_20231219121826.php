...
if (isset($_SESSION[$loggedInUsername]['processing_user']) && $_SESSION[$loggedInUsername]['processing_user'] !== $loggedInUsername) {
...
$_SESSION[$loggedInUsername]['processing_user'] = $loggedInUsername;
...
unset($_SESSION[$loggedInUsername]['processing_user']);
