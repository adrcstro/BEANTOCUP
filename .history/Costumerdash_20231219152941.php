...
if (!isset($_SESSION['user_data'])) {
    ...
    $_SESSION['user_data'] = getUserData($conn, $loggedInUsername);

    // Display the user details
    displayUserData($_SESSION['user_data']);
} else {
    // Display a message indicating that the page is being processed
    echo "This page is currently being processed. Please wait.";
}

// Close the database connection
mysqli_close($conn);

function getUserData($conn, $loggedInUsername) {
