...
$sessionKey = $loggedInUsername . '_' . $loggedInCostumerID;

// Check if user-specific data is already stored in the session
if (!isset($_SESSION['user_data'][$sessionKey])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Store user-specific data in the session based on the unique session key
        $_SESSION['user_data'][$sessionKey] = $userData;
    } else {
...
$userData = $_SESSION['user_data'][$sessionKey];
