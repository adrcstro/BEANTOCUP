...
// Check if user-specific data is already stored in the session and matches the current user
if (
    isset($_SESSION['user_data'][$loggedInCostumerID]) &&
    $_SESSION['user_data'][$loggedInCostumerID]['username'] == $loggedInUsername
) {
    // Display user details from the session
    $userData = $_SESSION['user_data'][$loggedInCostumerID];
} else {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Store user-specific data in the session based on CostumerID
