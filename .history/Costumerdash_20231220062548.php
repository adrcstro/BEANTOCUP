...
if (
    isset($_SESSION['last_login_time']) &&
    isset($_SESSION['user_data']) &&
    time() - $_SESSION['last_login_time'] < 60 // Adjust the time limit as needed
) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Store user-specific data and last login time in the session
