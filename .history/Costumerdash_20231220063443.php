...
$uniqueIdentifier = $_SESSION['CostumerID'];

// Fetch user data from the database based on the unique identifier
$query = "SELECT CostumerID, Name, Email, Phone, HomeAddress,Username FROM costumers WHERE CostumerID = '$uniqueIdentifier'";
