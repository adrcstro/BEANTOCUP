...
if (!isset($_COOKIE['CostumerID']) || !isset($_COOKIE['username'])) {
...
// Read and decrypt cookies to retrieve the username and CostumerID
$loggedInUsername = decrypt($_COOKIE['username']);
$loggedInCostumerID = decrypt($_COOKIE['CostumerID']);
...
if (mysqli_num_rows($result) > 0) {
    ...
    // Set encrypted cookies with user details
    setcookie('CostumerID', encrypt($userData['CostumerID']));
    setcookie('username', encrypt($loggedInUsername));
...
// Function to decrypt data (replace with a secure decryption method)
function decrypt($data) {
    // Replace this with a secure decryption method (e.g., AES decryption)
    return base64_decode($data);
}

// Function to encrypt data (replace with a secure encryption method)
function encrypt($data) {
    // Replace this with a secure encryption method (e.g., AES encryption)
