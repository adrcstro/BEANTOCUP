...
<div class="modal fade" id="BuyNow">
    ...
    <div class="d-flex justify-content-center">
        ...
        <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button" class="btn btn-sm m-1" onclick="updateRating(6)">
            Medium
        </button>
        <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button" class="btn btn-sm m-1" onclick="updateRating(6)">
            Large
...
<script>
    function updateRating(rating) {
        document.getElementById("RateTextArea").any = rating + "";
