...
<div class="modal fade" id="BuyNow">
    ...
    <div class="d-flex justify-content-center">
        ...
        <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button" class="btn btn-sm m-1 active-btn" onclick="updateRating('small')">
            Small
        </button>
        <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button" class="btn btn-sm m-1" onclick="updateRating('Medium')">
            Medium
        </button>
        <button style="background-color: transparent; color: #E48F45; border: 1px solid #E48F45;" type="button" class="btn btn-sm m-1" onclick="updateRating('Large')">
            Large
        </button>
...
<script>
  ...
  $(document).ready(function () {
    ...
    <input type="text" class="form-control"  id="searchInput" aria-label="Recipient's username" aria-describedby="button-addon2">
    <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary custom-width-btn" type="button" id="button-addon2">
        Total <!-- Bootstrap search icon -->
    </button>
</div>
