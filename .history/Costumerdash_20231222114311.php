...
<div class="modal fade" id="BuyNow">
    ...
    <div class="d-flex justify-content-center">
        ...
        <button  type="button" class="btn btn-sm m-1 active-btn" onclick="updateRating('small')">
            Small
        </button>
        <button  type="button" class="btn btn-sm m-1" onclick="updateRating('Medium')">
            Medium
        </button>
        <button type="button" class="btn btn-sm m-1" onclick="updateRating('Large')">
            Large
        </button>
