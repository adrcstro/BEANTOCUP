...
<script>
  $(document).ready(function () {
    ...
    var totalPriceInput = $('#searchInput'); // Assuming this is the input for the total price
    var pricePerUnit = 10; // Replace with the actual price per unit

    $('#increase-btn').click(function () {
      var currentValue = parseInt(quantityInput.val());
      quantityInput.val(currentValue + 1);

      // Double the price and update the total
      updateTotalPrice();
    });
    ...
    function updateTotalPrice() {
      ...
      var doubledPrice = pricePerUnit * 2 * quantity;
      totalPriceInput.val(doubledPrice);
    }
  });
</script>
