...
<script>
    $(document).ready(function () {
    var quantityInput = $('#quantity');
    var totalPriceInput = $('#searchInput'); // Assuming this is where you want to display the total price
    var itemPrice = parseFloat(data.Price); // Assuming data.Price is a numeric value
    ...
    $('#increase-btn').click(function () {
        ...
        totalPriceInput.val((totalPrice + itemPrice).toFixed(2)); // Display total with 2 decimal places
    });
