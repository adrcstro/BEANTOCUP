...
$(document).ready(function () {
    var quantityInput = $('#quantity');
    var totalPriceInput = $('#searchInput');
    var itemPrice = parseFloat(data.Price);

    // Initialize total price when the page loads
    totalPriceInput.val(itemPrice.toFixed(2));
    ...
    $('#increase-btn').click(function () {
        ...
        totalPriceInput.val((totalPrice + itemPrice).toFixed(2));
    });
...
$(document).on('click', '.buy-now-btn', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // Update total price when the quantity increases
            $('#increase-btn').click(function () {
            ...
            // Update total price when the quantity decreases
            $('#decrease-btn').click(function () {
                var currentValue = parseInt($('#quantity').val());
                if (currentValue > 1) {
                    $('#quantity').val(currentValue - 1);
