...
<script>
  ...
  $(document).ready(function () {
    ...
    <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary custom-width-btn" type="button" id="button-addon2" onclick="insertText()">
        Total
    </button>
</div>
...
<script>
    function insertText() {
        ...
        inputElement.value = "Text to be inserted";
    }
</script>
