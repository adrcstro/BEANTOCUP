...
<script>
    ...
    function setupButtonEvents() {
        ...
        increaseBtn.addEventListener("click", function() {
            updateTotal(2); // Double the value
        });

        decreaseBtn.addEventListener("click", function() {
            updateTotal(-2); // Decrease the added value
        });
    }

    function updateTotal(factor) {
        var totalElement = document.getElementById("total");
        var currentTotal = parseFloat(totalElement.value) || 0;

        // Update the total value by multiplying it with the factor
        var newTotal = currentTotal * factor;

        // Set the new total value in the input field
