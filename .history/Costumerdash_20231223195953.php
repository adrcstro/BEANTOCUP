...
echo '<button data-bs-toggle="offcanvas" data-bs-target="#BuyNow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="<?php echo $MEnuID; ?>">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="BuyNow">
    <div class="offcanvas-header" style="background-color: #E48F45;">
        <h5 class="offcanvas-title" style="color: #fff;"></h5>
    ...
    <div class="offcanvas-body">
        ...
        <div class="modal-footer text-center">
            ...
            <script>
                // Call the insertText function when the document is ready
            ...
            <button style="background-color: #E48F45; color: #fff;" data-bs-dismiss="offcanvas" data-toggle="offcanvas" data-bs-target="#cartOffcanvas" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-cart"></i> Add to Cart
            </button>
            <button style="background-color: #E48F45; color: #fff;" data-bs-dismiss="offcanvas" data-toggle="offcanvas" data-bs-target="#orderOffcanvas" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-bag"></i> Order Now
            </button>
        </div>
    </div>
