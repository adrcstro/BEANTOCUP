...
<div id="total" style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
    <label for="total"></label>
    <textarea class="form-control mx-auto" name="total" id="totalTextArea" style="width: 100%;"></textarea>
</div>
