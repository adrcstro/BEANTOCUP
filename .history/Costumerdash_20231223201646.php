...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Get the elements for quantity, increase button, decrease button, and total
        ...
        increaseButton.addEventListener("click", function() {
            totalValue *= 2; // Double the total value
            quantityInput.value = totalValue; // Update quantity input
            updateTotal(); // Update the total display
        });

        // Event listener for decrease button
        decreaseButton.addEventListener("click", function() {
            totalValue /= 2; // Halve the total value
            quantityInput.value = totalValue; // Update quantity input
            updateTotal(); // Update the total display
        });
    });
    ...
    function updateTotal() {
        ...
        totalInput.value = "Total: $" + totalValue.toFixed(2); // Display total as currency
    }
</script>
