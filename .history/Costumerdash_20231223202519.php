...
document.addEventListener("DOMContentLoaded", function() {
    // Assuming you have a variable to store the current price
    var currentPrice = 0;
    ...
    $(document).on('click', '.buy-now-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                currentPrice = parseFloat(data.Price); // Ensure it's a number
    ...
    $('#increase-btn').on('click', function() {
        // Double the total price and update the input value
        currentPrice *= 2;
    ...
    $('#decrease-btn').on('click', function() {
        // Ensure the current price is not zero
        if (currentPrice !== 0) {
            // Subtract the added price and update the input value
            currentPrice /= 2;
            inputElement.value = currentPrice;
        }
    });
