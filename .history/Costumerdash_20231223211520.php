...
<script>
  $(document).ready(function () {
   ...
   <!-- Assuming this is the HTML where the price is displayed -->
<p id="currentPrice">Price: ${data.Price}</p>
...
<script>
    ...
    function insertText() {
        ...
        // Get the current price element by its ID
        ...
        increaseBtn.addEventListener("click", function () {
            // Extract the price from the current price element
            var currentPrice = parseFloat(currentPriceElement.textContent.match(/\d+\.\d+/)[0] || 0);

            // Double the current price
            var doubledPrice = currentPrice * 2;

            // Set the doubled price as the new value for the total input field
            inputElement.value = doubledPrice;
        });
    }
</script>
