...
<script>
    $(document).ready(function () {
        ...
        function updateTotal(quantity) {
            ...
            totalInput.val(totalPrice.toFixed(2)); // Format to two decimal places
        }
    ...
    var parsedPrice = parseFloat(data.Price);
    if (!isNaN(parsedPrice)) {
        currentPrice = parsedPrice;
        totalInput.val(currentPrice.toFixed(2)); // Format to two decimal places
    } else {
        console.error('Invalid price format');
            ...
            <button  style="background-color: #E48F45; color: #fff;" data-dismiss="modal" data-toggle="modal"  data-target="#Order"   type="button" class="btn  btn-sm m-1">
  ...
  <div class="row d-flex justify-content-center align-items-center">
    <div class="col-md-3">
      <div id="shorcard" class="card shadow ">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Please pay upon Delivery</p>
    ...
    <div id="shorcard" class="card shadow ">
        ...
        <div  class="card-body">
          ...
          <p class="card-text">We Accept Online Payment</p>
          <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">  
