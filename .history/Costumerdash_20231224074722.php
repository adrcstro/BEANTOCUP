...
<script>
  $(document).ready(function () {
    ...
    $('#increase-btn').click(function () {
      ...
      // Fetch the current price from the total input and update it
      var currentPrice = parseFloat(totalInput.val());
      totalInput.val((currentPrice + parseFloat(data.Price)).toFixed(2));
    });
