...
<script>
    function updateRating(rating) {
        ...
        // You can customize this value as per your requirement
            ...
            <div class="input-group mb-3 d-flex justify-content-center align-items-center" style="width: 500px;">
    <input type="text" class="form-control" id="total" aria-label="Recipient's username" aria-describedby="button-addon2" value="1">
    <div class="input-group-append">
        <button class="btn btn-outline-secondary quantity-btn" data-operation="decrease" type="button">-</button>
    </div>
    <div class="input-group-append">
        <button class="btn btn-outline-secondary quantity-btn" data-operation="increase" type="button">+</button>
    </div>
    <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary custom-width-btn" type="button" id="button-addon2">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Use jQuery to handle the click event for the Quantity buttons
    $(document).on('click', '.quantity-btn', function () {
        // Get the operation (increase or decrease) from the data attribute
        ...
        // Get the MenuID (you might need to adjust this part based on your actual HTML)
        var menuID = /* Replace with your logic to get the menuID */;
        ...
        $.ajax({
            ...
            success: function (data) {
                // Update the quantity variable with the fetched price
                quantity = data.Price;

                // Update the total amount based on the quantity and fetched price
                var totalAmount = quantity * data.Price;
