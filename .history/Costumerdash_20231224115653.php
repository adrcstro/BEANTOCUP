...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $(document).on('click', '.buy-now-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#total').val(parseFloat(data.Price) * quantity);
            },
    ...
    // Function to update the quantity display and total amount
    function updateQuantityDisplay() {
        // Fetch the current price from the input field
        var currentPrice = parseFloat($('#total').val());

        // Check if the currentPrice is NaN
        ...
        $('#total').val(currentPrice * quantity);

        // Display the current price in the total input box
        $('#total').attr('placeholder', 'Current Price: ' + currentPrice.toFixed(2));
