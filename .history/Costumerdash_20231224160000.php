...
<script>
    function updateRating(rating) {
        ...
        <div class="input-group-append">
            <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary buy-now-btn" type="button" id="button-addon2" data-menuid="your_menu_id">
    ...
    <script>
        $(document).ready(function () {
            // Use jQuery to handle the click event for the Buy Now button
            $('#button-addon2').on('click', function () {
                // Replace 'your_menu_id' with the actual menu ID you want to fetch
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // Set the fetched price as the initial price
                        fetchedPrice = parseFloat(data.Price);
                        updateTotal(); // Update total when fetching the price
                    },
            ...
            var fetchedPrice = 0; // Initialize fetchedPrice variable
