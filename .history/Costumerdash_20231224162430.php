...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#button-addon2').on('click', function () {
            // Fetch the actual price using AJAX
            fetchActualPrice();
        });
        ...
        function fetchActualPrice() {
            // Use AJAX to fetch the actual price
            $.ajax({
                type: 'POST',
                url: 'fetch_item_data.php', // Update the URL accordingly
                data: { menuID: /* Provide the appropriate menuID here */ },
                dataType: 'json',
                success: function (data) {
                    // Update fetchedPrice with the actual price
                    var fetchedPrice = parseFloat(data.Price);
                    updateTotal(fetchedPrice);
                },
        ...
        function updateTotal(fetchedPrice) {
