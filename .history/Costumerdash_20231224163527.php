...
<script>
    ...
    <script>
    // Declare a global variable to store the fetched price
    var fetchedPrice;
        ...
        $(document).on('click', '.buy-now-btn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // Set the global variable to the fetched price
                    fetchedPrice = data.Price;

                    // Optionally, update any other elements with the new data if needed
                    // $('#someOtherElement').text(data.SomeOtherValue);
                },
...
<script>
    $(document).ready(function () {
        ...
        $('#button-addon2').on('click', function () {
            // Set the value of the input field to the dynamically fetched price
            updateTotal();
        });
