...
<script>
    ...
    <script>
    $(document).ready(function () {
        var fetchedPrice; // Declare the variable without assigning a value initially
        var quantity = 1;
        ...
        $(document).on('click', '.buy-now-btn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // Set the fetched price to the actual value
                    fetchedPrice = data.Price;

                    // Set the value of the input field to the fetched price
                    $('#total').val(fetchedPrice);

                    // Update quantity to 1 when a new item is selected
                    quantity = 1;
                    updateTotal();
                },
