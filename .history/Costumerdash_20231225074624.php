...
<script>
    ...
    $(document).ready(function () {
        ...
        // Initialize fetchedPrice with a default value
        var fetchedPrice = 25.00;

        // Initialize total value
        updateTotal();

        // Click event for the Buy Now buttons
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (!isNaN(parseFloat(data.Price))) {
                        ...
                        // Update the fetched price variable globally
                        fetchedPrice = parseFloat(data.Price);

                        // Update total based on the new fetched price
                        updateTotal();
                    } else {
                        console.error('Invalid price format received from fetch_item_data.php');
                    }
                },
        ...
        function updateTotal() {
            // Calculate the total based on the fetched price and quantity
            var total = fetchedPrice * quantity;

            // Update the 'total' and 'quantity' input fields
