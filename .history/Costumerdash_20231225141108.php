...
function logout() {
        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div  id="Passengers-table" style="display:none;" class="card shadow border-0 mb-7">
                    ...
                    <?php
 $secretString = 'c0st0m3rD45h_';  // Change this to the same unique string used in login.php
 session_name($secretString . $_SESSION['username']);
 session_start();
 ...
 if (!isset($_SESSION['CostumerID'])) {
  ...
  // Retrieve the username and CostumerID from the session
  $loggedInUsername = $_SESSION['username'];
  $loggedInCostumerID = $_SESSION['CostumerID'];
  
  // Fetch user details from the database
  $query = "SELECT CostumerID, Name, Email, Phone, HomeAddress FROM costumers WHERE Username = '$loggedInUsername'";
  ...
  if (mysqli_num_rows($result) > 0) {
      ...
      $_SESSION['CostumerID'] = $userData['CostumerID'];
