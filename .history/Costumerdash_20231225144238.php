...
// Fetch user details from the database using some identifier (you need a way to uniquely identify the user)
// For example, you might pass a user ID through the URL or another means
// Replace '1' with the actual identifier you are using
$loggedInCostumerID = 1; // Replace with your identifier

$query = "SELECT CostumerID, Name, Email, Phone, HomeAddress FROM costumers WHERE CostumerID = '$loggedInCostumerID'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<p>hi, {$userData['Name']}!</p>";
    echo "<p>Welcome to your dashboard, {$userData['Name']}!</p>";
    echo "<p>CostumerID: {$userData['CostumerID']}</p>";
