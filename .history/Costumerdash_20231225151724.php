...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<div style="display: flex; justify-content: center; align-items: center; text-align: left;">';
        echo '<div style="flex: 1; max-width: 400px; padding-right: 20px;">';
        
        // Replace echoed text with input fields
        echo '<label for="username">Username:</label>';
        echo "<input type='text' id='username' value='$loggedInUsername' readonly><br>";
        
        echo '<label for="name">Name:</label>';
        echo "<input type='text' id='name' value='{$userData['Name']}' readonly><br>";
        
        echo '<label for="customerID">CostumerID:</label>';
        echo "<input type='text' id='customerID' value='$loggedInCostumerID' readonly><br>";
        
        echo '<label for="email">Email:</label>';
        echo "<input type='text' id='email' value='{$userData['Email']}' readonly><br>";
        
        echo '<label for="phone">Phone:</label>';
        echo "<input type='text' id='phone' value='{$userData['Phone']}' readonly><br>";
        
        echo '<label for="address">Home Address:</label>';
        echo "<input type='text' id='address' value='{$userData['HomeAddress']}' readonly><br>";
        
        echo '</div>';

// Add your image URL in the src attribute
$imageURL = '../Images/personalinfo.svg';
echo "<div style='flex: 1;'><img src='$imageURL' alt='Image'></div>";
