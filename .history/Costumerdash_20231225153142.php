...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<img src="../Images/personalinfo.svg" alt="Your Image" style="max-width: 100%;">';
        echo '</div>';
        echo '<div style="display: flex; align-items: center; border: 1px solid #ccc; padding: 10px;">';
        echo '<input type="text" readonly style="flex: 1; border: none; outline: none; background-color: transparent;">';
        ...
        echo "<p>CustomerID: $loggedInCostumerID</p>";
