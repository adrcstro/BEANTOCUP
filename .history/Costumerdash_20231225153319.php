...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Image code goes here, for example:
            echo '<img src="../Images/personalinfo.svg" alt="Your Image" style="max-width: 90%;">';
        echo '</div>';
        echo '<div style="flex: 1; text-align: left; padding-left: 20px;">';
        echo "<input type='text' value='hi, $loggedInUsername!' readonly>";
        echo "<input type='text' value='Full Name, {$userData['Name']}!' readonly>";
        echo "<input type='text' value='CustomerID: $loggedInCostumerID' readonly>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly>";
        echo '</div>';
        echo '</div>';
