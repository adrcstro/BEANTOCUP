...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div>";
        echo "<input type='text' value='Hi, $loggedInUsername!' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Welcome to your dashboard, {$userData['Name']}!' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='CustomerID: $loggedInCostumerID' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly style='border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "</div>";
        echo "</div>";
