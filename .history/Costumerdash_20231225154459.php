...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<img src='../Images/personalinfo.svg' alt='User Image' style='margin-right: 10px; width: 100px; height: 100px;'>";
        echo "<div>";
        echo "<div style='display: flex; align-items: center;'>";
echo "<img src='path/to/your/image.jpg' alt='User Image' style='margin-right: 10px; width: 100px; height: 100px;'>";
