...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div style='display: flex; align-items: center; justify-content: center; width: 100%; height: 100vh;'>"; // Center content vertically and horizontally
        echo "<img src='../Images/personalinfo.svg' alt='User Image' style='margin-right: 10px; width: 150px; height: 150px;'>"; // Increase width and height of the image
        echo "<div style='display: flex; flex-direction: column;'>";
        echo "<input type='text' value='Hi, $loggedInUsername!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Welcome to your dashboard, {$userData['Name']}!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='CustomerID: $loggedInCostumerID' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "</div>";
        echo "</div>";
