...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<p>Hi:<input type='text' value=' $loggedInUsername!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
        echo "<input type='text' value=' {$userData['Name']}!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px;'>";
