...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<input type='text' value='Hi, $loggedInUsername!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
        echo "<input type='text' value='Welcome to your dashboard, {$userData['Name']}!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
        echo "<input type='text' value='CustomerID: $loggedInCostumerID' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 500px;'>";
