...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div style='display: flex; justify-content: center; align-items: center; flex-wrap: wrap;'>"; // Added 'flex-wrap: wrap;' for responsiveness
        echo "<img src='../Images/personalinfo.svg' alt='User Image' style='margin-right: 10px; max-width: 100%; height: auto;'>"; // Set max-width to 100% for responsiveness
        echo "<div style='display: flex; flex-direction: column; width: 100%; max-width: 600px;'>"; // Set max-width for responsiveness
