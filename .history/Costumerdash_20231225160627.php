...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div style='display: flex; justify-content: center; align-items: center; max-width: 800px; margin: 0 auto;'>"; // Set a specific max-width for the container
        ...
        echo "<div style='flex-grow: 1;'>"; // Allow the container to grow to fill the available space
