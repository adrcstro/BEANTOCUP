...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div style='display: flex; flex-wrap: wrap; justify-content: center; align-items: center; max-width: 800px; margin: 0 auto;'>"; // Set a specific max-width for the container
        echo "<img src='../Images/personalinfo.svg' alt='User Image' style='margin-right: 10px; width: 400px; height: 400px;'>"; // Keep the original width and height for the image
        echo "<div style='flex-grow: 1; width: 100%;'>"; // Allow the container to grow to fill the available space
        
        // Add the 'width' property to make the input fields wider
        echo "<input type='text' value='Welcome: $loggedInUsername!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
        echo "<input type='text' value='Full Name: {$userData['Name']}!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
        echo "<input type='text' value='Customer ID: $loggedInCostumerID' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 100%;'>";
...
echo '<button data-toggle="modal" data-target="#BuyNow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '"> <i class="fas fa-shopping-bag"></i>  Order Now</button>';
...
<div id="Rate" style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
    <label for="Rate"></label>
    <textarea class="form-control mx-auto" name="Rate" id="RateTextArea" style="width: 100%;"></textarea>
</div>
...
<div  class="input-group mb-3 d-flex justify-content-center align-items-center mt-2" style="max-width: 400px; margin: auto;">
        <span class="input-group-prepend">
            <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary" type="button" id="decreaseQuantity">-</button>
        </span>
        <input type="text" class="form-control text-center" id="quantity" value="1" readonly>
        <span class="input-group-append">
            <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary" type="button" id="increaseQuantity">+</button>
        </span>
    </div>
        ...
        <input type="text" class="form-control" id="total" aria-label="Recipient's username" aria-describedby="button-addon2">
        <div class="input-group-append">
            <button style="background-color: #E48F45; color: #fff;" class="btn btn-outline-secondary" type="button" id="button-addon2">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $(document).on('click', '.buy-now-btn', function() {
            ...
            <button  style="background-color: #E48F45; color: #fff;" data-dismiss="modal" data-toggle="modal"  data-target="#payment"   type="button" class="btn  btn-sm m-1">
...
<div class="modal fade" id="payment">
        <div class="modal-dialog" id="Payment">
            <div class="modal-content">

                <!-- Modal Header -->
                <div style="background-color: #E48F45;" class="modal-header">
                <h4 style="color: #fff;" class="modal-title">Select Payment Method</h4>
                <button style="background-color: #E48F45; color: #fff;" type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
  ...
  <div class="row d-flex justify-content-center align-items-center">
    <div class="col-md-3">
      <div id="shorcard" class="card shadow ">
        <img src="../Images/COD.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
          <h5 class="card-title">Cash on Delivery</h5>
          <p class="card-text">Please pay Upon Delevery</p>
    ...
    <div class="col-md-3 ">
    <div id="shorcard" class="card shadow ">
        <img src="../Images/Onlinepay.svg" class="card-img-top" alt="Card Image">
        <div  class="card-body">
          <h5 class="card-title">Pay Online</h5>
          <p class="card-text">We accept Online Payments</p>
          <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">  
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr>
        <td><img src="uploads/' . $row["Orderimage"] . '" alt="Item Image" width="100"></td>
                <td>' . $row["orderid "] . '</td>
                <td>' . $row["Ordername"] . '</td>
