...
echo  '<img src="Images/personalinfo.svg" class="img-fluid mb-5">';
echo "</div>";


echo '<div class="col-md-6">';
echo '<h2 class="mt-7 text-center" id="FAQ">Edit Your Personal </h2>';
...
echo "</div>";
        ...
        echo "<img src='../Images/personalinfo.svg' alt='User Image' style='margin-right: 10px; width: 400px; height: 400px;'>";
        echo "<div style='display: flex; flex-direction: column;'>";
        
        // Add the 'width' property to make the input fields wider
        echo "<input type='text' value='Welcome: $loggedInUsername!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
        echo "<input type='text' value='Full NAme: {$userData['Name']}!' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
        echo "<input type='text' value='CustomerID: $loggedInCostumerID' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
        echo "<input type='text' value='Email: {$userData['Email']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
        echo "<input type='text' value='Phone: {$userData['Phone']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
        echo "<input type='text' value='Home Address: {$userData['HomeAddress']}' readonly style='border: 1px solid black; border-radius: 10px; padding: 5px; margin-bottom: 5px; width: 450px;'>";
