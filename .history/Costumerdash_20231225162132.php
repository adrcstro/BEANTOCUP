...
echo "<div class='mb-3'>";
echo "<label for='loggedInUsername' class='form-label'>Welcome</label>";
echo "<input type='text' id='loggedInUsername' value='$loggedInUsername' class='form-control' readonly>";
echo "</div>";
...
echo "<div class='mb-3'>";
echo "<label for='customerID' class='form-label'>Customer ID</label>";
echo "<input type='text' id='customerID' value='$loggedInCostumerID' class='form-control' readonly>";
echo "</div>";

echo "<div class='mb-3'>";
echo "<label for='email' class='form-label'>Email</label>";
echo "<input type='text' id='email' value='{$userData['Email']}' class='form-control' readonly>";
echo "</div>";

echo "<div class='mb-3'>";
echo "<label for='phone' class='form-label'>Phone</label>";
echo "<input type='text' id='phone' value='{$userData['Phone']}' class='form-control' readonly>";
echo "</div>";

echo "<div class='mb-3'>";
echo "<label for='homeAddress' class='form-label'>Home Address</label>";
echo "<input type='text' id='homeAddress' value='{$userData['HomeAddress']}' class='form-control' readonly>";
echo "</div>";
