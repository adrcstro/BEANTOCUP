...
<!-- Bootstrap CSS (place this in the head section of your HTML) -->

<!-- Bootstrap CSS (place this in the head section of your HTML) -->
<!-- Bootstrap CSS (use a specific version to avoid unexpected changes) -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css" rel="stylesheet">

<!-- Bootstrap JavaScript with Popper.js (include only the components you need) -->
...
<!-- Bootstrap Offcanvas Component JavaScript with Popper.js -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>
