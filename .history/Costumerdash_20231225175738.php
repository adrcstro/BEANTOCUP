...
<!-- Your custom Bootstrap CSS containing only the styles related to offcanvas -->
<link href="path/to/custom-bootstrap-offcanvas.css" rel="stylesheet">

<!-- Your custom Bootstrap JavaScript containing only the offcanvas functionality -->
<script src="path/to/custom-bootstrap-offcanvas.js"></script>
...
echo '<button data-bs-toggle="offcanvas" data-bs-target="#BuyNowOffcanvas" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="BuyNowOffcanvas" aria-labelledby="BuyNowOffcanvasLabel">
    <div class="offcanvas-header" style="background-color: #E48F45;">
        <h4 style="color: #fff;" class="modal-title" id="BuyNowOffcanvasLabel">Buy Now Offcanvas</h4>
        <button style="background-color: #E48F45; color: #fff;" type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    ...
    <div class="offcanvas-body">
        ...
        <div class="modal-footer text-center">
            <button style="background-color: #E48F45; color: #fff;" data-dismiss="offcanvas" data-toggle="modal" data-target="#" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-cart"></i> Add to Cart
            </button>
            <button style="background-color: #E48F45; color: #fff;" data-dismiss="offcanvas" data-toggle="modal" data-target="#payment" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-bag"></i> Order Now
            </button>
        </div>
    </div>
...
$(document).on('click', '.buy-now-btn', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#BuyNowOffcanvas .modal-title').text(data.Name);
            $('#BuyNowOffcanvas .modal-body').html(`
                <div class="row">
                    <div class="col-md-6">
