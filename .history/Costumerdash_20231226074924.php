...
echo '<button data-toggle="modal" data-bs-toggle="offcanvas" href="#Buynow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '"> <i class="fas fa-shopping-bag"></i>  Order Now</button>';
