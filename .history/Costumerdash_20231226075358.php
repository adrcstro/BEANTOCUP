...
echo '<button data-bs-toggle="offcanvas" href="#offcanvasExample" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '"> <i class="fas fa-shopping-bag"></i>  Order Now</button>';
...
$(document).on('click', '.buy-now-btn', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#offcanvasExample .modal-title').text(data.Name);
