...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<input type='text' id='fullName' value='{$userData['Name']}' class='form-control' readonly style='background-color: #F5F5F5;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='email'><i class='fas fa-envelope'></i> Email</label>";
        echo "<input type='text' id='email' value='{$userData['Email']}' class='form-control' readonly style='background-color: #F5F5F5;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='phone'><i class='fas fa-phone'></i> Phone</label>";
        echo "<input type='text' id='phone' value='{$userData['Phone']}' class='form-control' readonly style='background-color: #F5F5F5;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='homeAddress'><i class='fas fa-home'></i> Home Address</label>";
        echo "<input type='text' id='homeAddress' value='{$userData['HomeAddress']}' class='form-control' readonly style='background-color: #F5F5F5;'>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
