...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div class='container mt-2'>";
        echo '<button id="showButton" class="btn btn-primary">Show</button>';
        echo '<button id="hideButton" class="btn btn-danger" style="display:none;">Hide</button>';
        echo "<div class='mb-3' id='inputFields' style='display:none;'>";
        echo "<label for='fullName'><i class='fas fa-user'></i> Full Name</label>";
        echo "<input type='text' id='fullName' value='{$userData['Name']}' class='form-control' readonly style='background-color: #E48F45;'>";
        echo "</div>";
        echo "<div class='mb-3' id='inputFields' style='display:none;'>";
        echo "<label for='email'><i class='fas fa-envelope'></i> Email</label>";
        echo "<input type='text' id='email' value='{$userData['Email']}' class='form-control' readonly style='background-color: #E48F45;'>";
        echo "</div>";
        echo "<div class='mb-3' id='inputFields' style='display:none;'>";
        echo "<label for='phone'><i class='fas fa-phone'></i> Phone</label>";
        echo "<input type='text' id='phone' value='{$userData['Phone']}' class='form-control' readonly style='background-color: #E48F45;'>";
        echo "</div>";
        echo "<div class='mb-3' id='inputFields' style='display:none;'>";
        echo "<label for='homeAddress'><i class='fas fa-home'></i> Home Address</label>";
        echo "<input type='text' id='homeAddress' value='{$userData['HomeAddress']}' class='form-control' readonly style='background-color: #E48F45;'>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
