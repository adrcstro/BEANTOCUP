...
<div class="input-group mb-3 d-flex justify-content-center align-items-center mt-2" style="max-width: 300px; margin: auto;">
    <span class="input-group-prepend">
        <button style="background-color: #E48F45; color: #fff; font-size: 14px; border-radius: 50%; padding: 8px 12px;" class="btn btn-outline-secondary" type="button" id="decreaseQuantity">-</button>
    </span>
    <input type="text" class="form-control text-center" id="quantity" value="1" readonly style="width: 50px; font-size: 14px;">
    <span class="input-group-append">
        <button style="background-color: #E48F45; color: #fff; font-size: 14px; border-radius: 50%; padding: 8px 12px;" class="btn btn-outline-secondary" type="button" id="increaseQuantity">+</button>
    </span>
</div>
