...
<div class="input-group mb-3 d-flex justify-content-center align-items-center mt-4" style="max-width: 200px; margin: auto;">
    <input type="text" class="form-control text-center" id="quantity" value="1" readonly style="width: 50px; font-size: 14px; border: 1px solid #E48F45; border-radius: 4px; order: 1;">
    <span class="input-group-prepend" style="order: 2;">
    ...
    <span class="input-group-append" style="order: 3;">
