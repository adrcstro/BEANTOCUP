...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div class='container mt-2'>";
        echo "<div class='mb-3'>";
        echo "<label for='fullName'><i class='fas fa-user'></i> Full Name</label>";
        echo "<input type='text' id='fullName' value='{$userData['Name']}' class='form-control' readonly style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='email'><i class='fas fa-envelope'></i> Email</label>";
        echo "<input type='text' id='email' value='{$userData['Email']}' class='form-control' readonly style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='phone'><i class='fas fa-phone'></i> Phone</label>";
        echo "<input type='text' id='phone' value='{$userData['Phone']}' class='form-control' readonly style='background-color: #fff;'>";
        echo "</div>";
        echo "<div class='mb-3'>";
        echo "<label for='homeAddress'><i class='fas fa-home'></i> Home Address</label>";
        echo "<input type='text' id='homeAddress' value='{$userData['HomeAddress']}' class='form-control' readonly style='background-color: #fff;'>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
...
<div id="Rate" style="width: 80%; margin: auto; display:none;  margin-bottom: 10px;">
...
<div class="input-group mb-3 d-flex justify-content-between align-items-center mt-4" style="max-width: 200px; margin: auto;">
    <span class="ml-2" style="font-size: 14px;">Quantity:</span>
    
    <div class="d-flex">
        <span class="input-group-prepend">
            <button style="background-color: #E48F45; color: #fff; font-size: 14px; border: 1px solid #E48F45; padding: 8px 12px;" class="btn btn-outline-secondary" type="button" id="decreaseQuantity">-</button>
        </span>
        
        <input type="text" class="form-control text-center" id="quantity" value="1" readonly style="width: 50px; font-size: 14px; border: 1px solid #E48F45; border-radius: 0;">
        
        <span class="input-group-append">
            <button style="background-color: #E48F45; color: #fff; font-size: 14px; border: 1px solid #E48F45; padding: 8px 12px;" class="btn btn-outline-secondary" type="button" id="increaseQuantity">+</button>
        </span>
    </div>
</div>
