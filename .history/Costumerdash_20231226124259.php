...
<div class="quantity-control-container grid">
    <label for="quantity" class="quantity-label mt-5">Quantity:</label>

    <div class="quantity-control mt-4 mb-4">
        <button class="quantity-btn" type="button" id="decreaseQuantity">-</button>

        <input type="text" class="quantity-input" id="quantity" value="1" readonly>

        <button class="quantity-btn" type="button" id="increaseQuantity">+</button>
    </div>
</div>
