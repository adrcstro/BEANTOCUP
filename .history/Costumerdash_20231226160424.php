...
<div class="input-group mb-3 d-flex justify-content-end align-items-center mt-4" style="max-width: 200px; margin: auto;">
    <div class="input-group-prepend">
        <span class="input-group-text" style="background-color: #E48F45; color: #fff; border: 1px solid #E48F45; border-radius: 4px;">Quantity</span>
    </div>
    <div class="input-group-prepend">
