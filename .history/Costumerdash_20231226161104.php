...
echo '<button class="btn btn-sm-custom mr-1 buy-now-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBuyNow" data-id="<?php echo $MEnuID; ?>">
...
<!-- Offcanvas Container -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBuyNow" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header" style="background-color: #E48F45;">
        <h4 style="color: #fff;" class="modal-title">Order Information</h4>
        <button style="background-color: #E48F45; color: #fff;" type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        ...
        <div class="container mt-2">
            <div class="row justify-content-center">
                <div class="col-md-17">
                    <h2 class="mt-7 text-center" id="FAQ">Order Information</h2>
        ...
        <div class="modal-footer text-center">
            <button style="background-color: #E48F45; color: #fff;" data-bs-dismiss="offcanvas" data-bs-toggle="modal" data-bs-target="#" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-cart"></i> Add to Order
            </button>
            <button style="background-color: #E48F45; color: #fff;" data-bs-dismiss="offcanvas" data-bs-toggle="modal" data-bs-target="#payment" type="button" class="btn btn-sm m-1">
                <i class="fas fa-shopping-bag"></i> Order Now
            </button>
        </div>
    </div>
