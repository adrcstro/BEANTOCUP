...
echo '<button data-bs-toggle="offcanvas"  data-bs-target="#BuyNow" aria-controls="BuyNow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '"> <i class="fas fa-shopping-bag"></i>  Order Now</button>';
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="BuyNow">
    <div class="modal-dialog" id="ordermodal">
        <div class="modal-content">

            <!-- Modal Header -->
            <div style="background-color: #E48F45;" class="offcanvas-header">
...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        // Fetch the user data
        $userData = mysqli_fetch_assoc($result);
        echo '<div class=" style="display:none;" container">';
