...
echo '<button id="toggleFields" onclick="toggleFields()">Hide/Show Fields</button>'; // Add the button


        echo "<div class='container mt-2' id='orderInformation'>";
        echo "<div class='mb-3'>";
        ...
        echo '<script>';
echo 'function toggleFields() {';
echo '  var orderInformationDiv = document.getElementById("orderInformation");';
echo '  if (orderInformationDiv.style.display === "none") {';
echo '    orderInformationDiv.style.display = "block";';
echo '  } else {';
echo '    orderInformationDiv.style.display = "none";';
echo '  }';
echo '}';
echo '</script>';
...
<div class="input-group mb-3 d-flex justify-content-center align-items-center mt-4" style="max-width: 200px; margin: auto;">
    ...
    <input type="text" class="form-control text-center" id="quantity" value="1" readonly style="width: 50px; font-size: 14px; border: 1px solid #E48F45; border-radius: 4px; margin: 0 5px;">
