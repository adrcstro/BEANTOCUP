...
<script>
  function toggleOrderInfo() {
    var orderInfoContent = document.getElementById('orderInfoContent');
    orderInfoContent.style.display = (orderInfoContent.style.display === 'none' || orderInfoContent.style.display === '') ? 'block' : 'none';
  }
</script>
