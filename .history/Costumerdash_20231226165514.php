...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<a class="dropdown-item" href="#" onclick="toggleOrderInfo()">Show</a>';
        echo '<a class="dropdown-item" href="#" onclick="toggleOrderInfo()">Hide</a>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<script>';
echo 'function toggleOrderInfo() {';
echo '  var orderInfoContent = document.getElementById("orderInfoContent");';
echo '  orderInfoContent.style.display = (orderInfoContent.style.display === "none" || orderInfoContent.style.display === "") ? "block" : "none";';
echo '}';
echo '</script>';
