...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<button id="showFields" onclick="showFields()">Show</button>';
        echo '<button id="hideFields" style="display:none;" onclick="hideFields()">Hide</button>';
        ...
        // Add JavaScript functions to show and hide fields
        echo "<script>
            function showFields() {
                document.getElementById('showFields').style.display = 'none';
                document.getElementById('hideFields').style.display = 'block';
                document.querySelector('#ordeinfo .container .mb-3').style.display = 'block';
            }
        
            function hideFields() {
                document.getElementById('showFields').style.display = 'block';
                document.getElementById('hideFields').style.display = 'none';
                document.querySelector('#ordeinfo .container .mb-3').style.display = 'none';
            }
        </script>";
