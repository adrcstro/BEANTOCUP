...
<div style="text-align: center; display:flex; justify-content: center;" class="form-group mb-3 ">
        <label id="dateplace" for="dateplace">Date Ordered</label>
        <input style="width: 80%;" type="date" name="dateplace" class="form-control" required>
    </div>
