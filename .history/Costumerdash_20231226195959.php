...
<div style="text-align: center; display: flex; flex-direction: column; align-items: center;" class="form-group mb-3">
    <label id="dateplace" for="dateplace">Date Ordered</label>
    <div style="position: relative; width: 80%;">
        <i style="position: absolute; top: 50%; transform: translateY(-50%); left: 10px;" class="fas fa-calendar"></i>
        <input style="width: calc(100% - 30px); padding-left: 30px; margin: 0 auto;" type="date" name="dateplace" class="form-control" required>
    </div>
</div>
