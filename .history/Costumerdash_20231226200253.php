...
<div style="display: flex; flex-direction: column; align-items: flex-start;" class="form-group mb-3">
    <label id="dateplace" for="dateplace" style="margin-bottom: 5px;">Date Ordered</label>
    <div style="position: relative; display: flex; align-items: center; width: 90%;">
        <i class="your-icon-class" style="margin-right: 10px;"></i> <!-- Replace "your-icon-class" with the actual class for your icon -->
