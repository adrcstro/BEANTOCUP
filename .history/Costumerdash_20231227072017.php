...
<div class="modal fade" id="BuyNow">
 ...
 <!-- Assuming you have jQuery included before this script -->
<script>
$(document).on('click', '.buy-now-btn', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            $('#BuyNow .modal-footer').text('Edit Item');
            $('#BuyNow .modal-footer').html(`
                <div class="row">
                    <div class="col-md-6">
                        <label for="itemName">Name:</label>
                        <input type="text" id="itemName" class="form-control" value="${data.Name}" readonly>
                    </div>
                </div>
            `);
        },
