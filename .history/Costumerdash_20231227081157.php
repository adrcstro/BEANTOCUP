...
<div class="modal fade" id="BuyNow">
    <div class="modal-dialog" id="ordermodal">
        <div class="modal-content">
         ...
         <!-- Assuming this is your input field for the product name -->

<!-- Your input field with the new class -->
<input type="text" id="prodname" name="prodname" for="prodname" class="form-control productname center-input" />
