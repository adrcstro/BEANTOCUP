...
<div class="input-group mb-3 d-flex justify-content-center align-items-center mt-4" style="max-width: 200px; margin: auto;">
    <div class="input-group-prepend">
        <button style="background-color: #E48F45; color: #fff; font-size: 14px; border: 1px solid #E48F45; border-radius: 4px; padding: 8px 12px;" class="btn btn-outline-secondary ml-auto" type="button" id="decreaseQuantity">-</button>
    </div>
    ...
    <div class="input-group-append">
        <button style="background-color: #E48F45; color: #fff; font-size: 14px; border: 1px solid #E48F45; border-radius: 4px; padding: 8px 12px;" class="btn btn-outline-secondary mr-auto" type="button" id="increaseQuantity">+</button>
    </div>
</div>
