...
<div class="modal fade" id="BuyNow">
    <div class="modal-dialog" id="ordermodal">
        <div class="modal-content">
          ...
          <!-- Add an empty element for the input field -->
<!-- Add an empty element for the input field -->
<!-- Add an empty element for the input field -->
<!-- Add an empty element for the input field with initial display none -->
<div id="fileNameContainer" class="text-center mt-3" style="display: none;"></div>
