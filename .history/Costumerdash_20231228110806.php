...
<div id="fileNameContainer" for="fileNameContainer" name="fileNameContainer" class="text-center mt-3"></div>
...
<div class="input-group mb-3 d-flex justify-content-center align-items-center" style="max-width: 500px; margin: auto;">
    ...
    <div class="input-group-append">
        <span class="input-group-text">$</span>
            ...
            <button id="addtocart" style="background-color: #E48F45; color: #fff;" data-dismiss="modal" data-toggle="modal"  data-target="#"   type="button" class="btn  btn-sm m-1">
   ...
   $(function(){
    $('#addtocart').click(function(e){
        ...
        if(valid){
            ...
            formData.append('fileNameContainer', $('#fileNameContainer')[0].files[0]);
