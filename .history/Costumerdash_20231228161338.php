            ...
            $('#fileNameContainer').html(`
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center">
                        <input id="fileNameContainer" for="fileNameContainer" name="fileNameContainer" style="display: block;"  type="text" class="form-control text-center" value="${fileName}" readonly>
                    </div>
                </div>
            `);
        },
...
// Retrieve user information from URL parameters
$loggedInCostumerName = isset($_GET['CostumerName']) ? $_GET['CostumerName'] : null;

// Fetch data from the addtocarttbl table with a specific CostumerName
$sql = "SELECT * FROM addtocarttbl WHERE CostumerName = '$loggedInCostumerName'";
$result = $conn->query($sql);
