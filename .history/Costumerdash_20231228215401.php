...
// Move the $body content to the top
...
echo '<p class="lead">' . $trimmed_body . ' <a href="#" class="read-more-btn" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More  <i class="bi bi-arrow-right-square"></i></a></p>';
echo '</div>';
echo '</div>';
echo '</div>';
