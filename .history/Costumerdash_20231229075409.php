...
<div style="display: flex; flex-direction: column; align-items: center;" class="form-group mb-3">
    ...
    <h5 style="text-align: center; margin-bottom: 2px;">Options/Size</h5>
...
<script>
    ...
    ?>
                        ...
                        <div class="form-group">
  <label id="upaddorcostumerName" for="upaddorcostumerName">Update Costumer Name</label>
  <input  class="form-control" type="text"  name="upaddorcostumerName">
</div>
                <div class="form-group">
                    <label id="upaddorDateOrdered" for="upaddorDateOrdered">Update Date Ordered</label>
                    <input type="date" name="upaddorDateOrdered" class="form-control" required>
                </div>
                 <div class="form-group">
                    <label id="upaddorShippingAddress" for="upaddorShippingAddress">Update Shipping Address</label>
            ...
            <div class="form-group">
    <label id="upaddorPAymentmethod" for="upaddorPAymentmethod">Update Payment Method</label>
...
<div class="form-group">
                    <label id="upaddorContactNumber" for="upaddorContactNumber">Update Contact Number</label>
                    <input name="upaddorContactNumber" type="text" class="form-control" required>
                </div>

                <div class="form-group">
                    <label id="upaddorEmailAddress" for="upaddorEmailAddress">Update Email</label>
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button style="background-color: #E48F45; color: #fff;" id="orderUpdate" type="button" class="btn btn">SUpdate Details</button>
                </div>
