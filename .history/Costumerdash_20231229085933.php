...
<div class="modal fade" id="cosdeletorder">
    <div class="modal-dialog">
        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <div class="modal-body">
                <form  action="cosdeleteorder.php" method="post">
                    <div class="form-group">
...
<script>
        $(document).ready(function() {
            $('#cosorderDelete').submit(function(e) {
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: 'POST',
                    url: 'cosdeleteorder.php', // Make sure this is the correct path to your delete.php file
                    data: formData,
                    dataType: 'json', // Set the dataType to 'json' to parse the JSON response
                    success: function(response) {
                        showAlert(response.type, response.message);
