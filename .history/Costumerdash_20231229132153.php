...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<div class="card-buttons"><button data-toggle="modal" data-target="#BuyNow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '" onclick="hideInputFields()"> <i class="fas fa-shopping-bag"></i> Order Now</button>';
