        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="d-flex flex-column align-items-center ">
                ...
                <div class="d-flex justify-content-center">
                    <div class="menu-btns">
                        <button type="button" class="btn btn-primary btn-lg menu-btn mx-auto" onclick="updateRating('small')">
                            <i class="fa-solid fa-mug-hot"></i> Small
                        </button>
                        <button type="button" class="btn btn-primary btn-lg menu-btn mx-auto" onclick="updateRating('Medium')">
                            <i class="fa-solid fa-mug-hot"></i> Medium
                        </button>
                        <button type="button" class="btn btn-primary btn-lg menu-btn mx-auto" onclick="updateRating('Large')">
