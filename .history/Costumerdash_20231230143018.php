...
// Check if CostumerID is present
if ($loggedInCostumerID !== null) {
    // Fetch data from the ordertbl table for a specific CostumerID
    $sql = "SELECT * FROM ordertbl WHERE CostumerID = '$loggedInCostumerID'";
    ...
    // CostumerID missing, redirect to login
    header("Location: login.php");
    exit();
}
