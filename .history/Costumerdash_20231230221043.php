...
<div  id="trackorders-table" style="display:none;" class="card shadow border-0 mb-7">
                    <div class="card-header">
                        <h5 class="mb-0">Track Orders/Order History</h5>
                    </div>
                    <div class="table-responsive">
...
?>
  ...
  <div class="card shadow">
    <div class="card-body">
      ...
      <div class="progress">
        <div class="progress-bar progress-bar-on-process" role="progressbar" style="width: 33.33%;" aria-valuenow="33.33" aria-valuemin="0" aria-valuemax="100">
          <svg class="bi" width="16" height="16" fill="currentColor"><use xlink:href="bootstrap-icons.svg#gear"/></svg> On Process
        </div>
        <div class="progress-bar progress-bar-in-transit" role="progressbar" style="width: 33.33%;" aria-valuenow="33.33" aria-valuemin="0" aria-valuemax="100">
          <svg class="bi" width="16" height="16" fill="currentColor"><use xlink:href="bootstrap-icons.svg#truck"/></svg> In Transit
        </div>
        <div class="progress-bar progress-bar-delivered" role="progressbar" style="width: 33.33%;" aria-valuenow="33.33" aria-valuemin="0" aria-valuemax="100">
          <svg class="bi" width="16" height="16" fill="currentColor"><use xlink:href="bootstrap-icons.svg#check-circle"/></svg> Delivered
        </div>
      </div>
    </div>
  </div>
...
<button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn btn-sm m-1" data-toggle="modal"  data-target="#">
    <i class="bi bi-trash"></i> Cancel Order</button>
...
<div class="modal fade" id="cosdeletorder">
    <div class="modal-dialog">
        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <div class="modal-body">
            <form id="deleteOrderForm" action="cosdeleteorder.php" method="post">
                    <div class="form-group">
