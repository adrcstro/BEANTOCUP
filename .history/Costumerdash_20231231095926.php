...
echo '</tbody></table>';
        ...
        <ul class="list-group">
          <li class="list-group-item d-flex align-items-center">
            <div class="legend-color mr-3" style="background-color: gray;"></div>
            None
          </li>
          <li class="list-group-item d-flex align-items-center">
            <div class="legend-color mr-3" style="background-color: red;"></div>
            On Process
          </li>
          <li class="list-group-item d-flex align-items-center">
            <div class="legend-color mr-3" style="background-color: yellow;"></div>
            In Transit
          </li>
          <li class="list-group-item d-flex align-items-center">
            <div class="legend-color mr-3" style="background-color: green;"></div>
            Delivered
          </li>
        </ul>
      </div>';
