...
echo '</tbody></table>';
        ...
        <div class="form-check">
          <input type="checkbox" class="form-check-input" id="noneCheckbox" disabled>
          <label class="form-check-label" for="noneCheckbox">
            <span class="legend-color mr-2" style="background-color: gray;"></span>
            None
          </label>
        </div>
        <div class="form-check">
          <input type="checkbox" class="form-check-input" id="onProcessCheckbox" disabled>
          <label class="form-check-label" for="onProcessCheckbox">
            <span class="legend-color mr-2" style="background-color: red;"></span>
            On Process
          </label>
        </div>
        <div class="form-check">
          <input type="checkbox" class="form-check-input" id="inTransitCheckbox" disabled>
          <label class="form-check-label" for="inTransitCheckbox">
            <span class="legend-color mr-2" style="background-color: yellow;"></span>
            In Transit
          </label>
        </div>
        <div class="form-check">
          <input type="checkbox" class="form-check-input" id="deliveredCheckbox" disabled>
          <label class="form-check-label" for="deliveredCheckbox">
            <span class="legend-color mr-2" style="background-color: green;"></span>
            Delivered
          </label>
        </div>
      </div>';
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($statusResult->num_rows > 0) {
                        ...
                        // Only display the option if the status is not 'Delivered'
