...
echo '</tbody></table>';
        ...
        echo '<div class="container text-center notice-container">
        <h3>Important Notice!</h3>
        <div class="legend-item">
            If the Status stated in your Order is Blank/Empty, it is Eligible for Update and Cancellation of Order.<br>
            If the order status has an input like On Process, In Transit, and Delivered, it is not capable of editing and canceling your Order.
        </div>
    </div>';
    } else {
        // No matching user found based on CostumerID
