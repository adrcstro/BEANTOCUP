...
<div class="form-group">
  <label id="trackupaddorcostumerName" for="trackupaddorcostumerName">Costumer Name</label>
  <input  class="form-control" type="text"  name="trackupaddorcostumerName">
</div>
                <div class="form-group">
...
<div class="modal-footer">
  ...
  $(document).ready(function() {
    $("#trackorderUpdate").click(function() {
            ...
            var trackupaddorcostumerName = $("input[name='trackupaddorcostumerName']").val();
      ...
      $.post(
        "update.php", // Replace with the actual file name for update
        {
            ...
            trackupaddorcostumerName: trackupaddorcostumerName,
