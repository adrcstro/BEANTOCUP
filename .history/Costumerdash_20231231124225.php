...
<button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn btn-sm m-1" data-toggle="modal"  data-target="#Calcelorder">
...
<div class="modal fade" id="Calcelorder">
        <div id="addordersize" class="modal-dialog">
            <div  class="modal-content">
