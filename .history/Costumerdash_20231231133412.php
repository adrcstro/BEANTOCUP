...
<div class="modal" id="cancelorder">
    <div class="modal-dialog">
        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <form id="Delete" action="delete.php" method="post">
                    <div class="form-group">
                        <label for="trackuporderID">Delete Selected Order</label>
                        <select name="trackuporderID" id="trackuporderID" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
                            <?php
    // Modified PHP code
    ...
    ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button style="background-color: #E48F45; color: #fff;" id="trackorderUpdate" type="submit" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
   $(document).ready(function() {
    $('#trackorderUpdate').submit(function(e) {
        e.preventDefault();
        var formData = $(this).serialize();
        $.ajax({
            type: 'POST',
