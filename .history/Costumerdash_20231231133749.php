...
<div class="modal" id="cancelorder">
    <div class="modal-dialog">
        <div class="modal-content">
        <div style="background-color: #E48F45;" class="modal-header">
                    <h4 style="color: #fff;" class="modal-title">Cancel Order</h4>
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
            ...
            <form id="Delete" action="delete.php" method="post">
                    <div class="form-group">
                        <label for="cosordertrack">Delete Selected Order</label>
                        <select name="cosordertrack" id="cosordertrack" class="form-control" required>
                            <option value="" disabled selected>Select an option</option>
                            <?php
    // Modified PHP code
    $servername = "localhost";
    ...
    ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button style="background-color: #E48F45; color: #fff;" id="CostumerorderUP" type="submit" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
   $(document).ready(function() {
    $('#CostumerorderUP').submit(function(e) {
        e.preventDefault();
        var formData = $(this).serialize();
        $.ajax({
            type: 'POST',
