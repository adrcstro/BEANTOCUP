...
<div class="modal fade" id="cancelorder">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="Delete" action="trackdelete.php" method="post">
                    <div class="form-group">
                        <label for="Costuorderid">Delete Selected BRGY-ADMIN </label>
    ...
    ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="Cosorderdelte" type="submit" class="btn btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
        $(document).ready(function() {
            $('#Cosorderdelte').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'trackdelete.php', // Make sure this is the correct path to your delete.php file
                    data: formData,
                    dataType: 'json', // Set the dataType to 'json' to parse the JSON response
                    success: function(response) {
                        showAlert(response.type, response.message);
