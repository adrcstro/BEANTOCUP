...
<script>
        ...
        <div class="modal-dialog" id="orderprocessmodal">
            <div class="modal-content">
                ...
                <label for="orderId">Select Order ID to Confirm</label>
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="setstatus" type="button" class="btn btn">Confirm</button>
                </div>
