    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            <div class="text-center">
                <img src="../Images/recieve.svg" class="card-img-top w-75" alt="Card Image">
            </div>
            <div class="card-body text-center p-2"> <!-- Added 'p-2' class for padding -->
                <h5 class="card-title m-0">Order Receive</h5> <!-- Added 'm-0' class to remove margin from the card title -->
                <p class="card-text m-0">Order Complete</p> <!-- Added 'm-0' class to remove margin from the card text -->
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateConfi('Receive')">
                        <span class="pe-2">
                            <i class="bi bi-check-circle-fill"></i>
                        </span>
                        <span>Poor</span>
