...
<div class="modal fade" id="RateourSHop">
        ...
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateConfi('Poor')">
                        <span class="pe-2">
                            <i class="bi bi-check-circle-fill"></i>
                        </span>
                        <span>Poor</span>
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <p class="card-text m-0">Order Complete</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateConfi('Fair')">
                        <span class="pe-2">
                            <i class="bi bi-check-circle-fill"></i>
                        </span>
                        <span>Fair</span>
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <p class="card-text m-0">Order Complete</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateConfi('Very Good')">
                        <span class="pe-2">
                            <i class="bi bi-check-circle-fill"></i>
                        </span>
                        <span>Very Good</span>
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <p class="card-text m-0">Order Complete</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateConfi('Excellent')">
                        <span class="pe-2">
                            <i class="bi bi-check-circle-fill"></i>
                        </span>
                        <span>Excellent</span>
