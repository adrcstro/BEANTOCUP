...
<div class="comment-box mt-3" style="display: none;">
                    <label for="commentPoor">Comments:</label>
                    <textarea class="form-control" id="commentPoor" rows="3"></textarea>
                </div>


                <script>
    function showCommentBox(rating) {
        var commentBox = document.getElementById("comment" + rating);
...
<div style="width: 80%; margin: auto; display:nonr;  margin-bottom: 10px;">
