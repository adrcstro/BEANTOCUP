...
<div class="col-md-3 mb-4">
    <div id="orderReceiveCard" class="card shadow uniwqe">
        <!-- ... Card content ... -->
        <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
            <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="toggleCommentBox('Poor')">
                <span class="pe-2">
...
<div class="comment-box" style="display: none;">
            ...
            <button class="btn btn-primary mt-2" onclick="submitComment('Poor')">Submit Comment</button>
        </div>
<script>
