...
<div class="row d-flex justify-content-center align-items-center mt-4 mb-4">
        ...
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateratings('Poor')">
                        <span class="pe-2">
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateratings('Fair')">
                        <span class="pe-2">
                        <i class="bi bi-star-fill"></i>
                        </span>
                        <span>Fair</span>
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateratings('Very Good')">
                        <span class="pe-2">
                        <i class="bi bi-star-fill"></i>
                        </span>
                        <span>Very Good</span>
    ...
    <div class="col-md-3 mb-4">
        <div id="orderReceiveCard" class="card shadow uniwqe">
            ...
            <div class="card-body text-center p-2 mt-n2"> <!-- Added 'mt-n2' class for negative margin -->
                ...
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="updateratings('Excellent')">
                        <span class="pe-2">
                        <i class="bi bi-star-fill"></i>
                        </span>
                        <span>Excellent</span>
...
<div class="comment-box" style="display: none;">
            <!-- Comment box content goes here -->
            <textarea class="form-control" rows="3" placeholder="Leave your comment"></textarea>
          
        </div>
<script>
function toggleCommentBox(rating) {
    // Get the comment box element for the corresponding rating
...
function submitComment(rating) {
    // Implement the logic to submit the comment for the given rating
    // You can retrieve the comment from the textarea and send it to the server or perform other actions
    var comment = document.querySelector('.comment-box textarea').value;
    console.log('Rating:', rating, 'Comment:', comment);

    // Optionally, you can hide the comment box after submission
