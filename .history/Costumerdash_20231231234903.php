...
<div class="modal fade" id="RateourSHop">
    ...
    <div class="col-md-3 mb-4">
        ...
        <div class="card-body text-center p-2 mt-n2">
            ...
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" onclick="toggleTextArea()">
                    <span class="pe-2">
                        <i class="bi bi-star-fill"></i>
                    </span>
                    <span>Excellent</span>
            ...
            <!-- Add the textarea with an ID for easy access in JavaScript -->
            <textarea id="ratingTextArea" class="form-control mt-2" style="display: none;" placeholder="Enter your comments"></textarea>
        </div>
...
<script>
    function toggleTextArea() {
        ...
        var textarea = document.getElementById("ratingTextArea");
