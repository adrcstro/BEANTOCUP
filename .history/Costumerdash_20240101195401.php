...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Display data in input fields with CSS styles
            echo '<div style="margin-bottom: 10px;">
                    <label>Items Ordered:</label>
                    <input type="text" name="items_ordered" value="' . implode(',', $itemsOrdered) . '" style="border: 1px solid #ccc; padding: 5px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>Size:</label>
                    <input type="text" name="size" value="' . implode(',', $sizes) . '" style="border: 1px solid #ccc; padding: 5px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>Quantity:</label>
                    <input type="text" name="qty" value="' . implode(',', $qtys) . '" style="border: 1px solid #ccc; padding: 5px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>Total Amount:</label>
                    <input type="text" name="total_amount" value="' . $totalAmount . '" style="border: 1px solid #ccc; padding: 5px;">
                </div>
                <input type="submit" value="Submit" style="background-color: #4CAF50; color: white; padding: 10px; border: none; cursor: pointer;">
            </form>
        </div>';
        } else {
            echo "0 results";
