...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<div style="margin-bottom: 10px; width: 100%;">
        ...
        <input type="submit" value="Submit" style="background-color: #4CAF50; color: white; padding: 10px; border: none; cursor: pointer; width: 100%;">
    </form>
    </div>';
        } else {
            echo "0 results";
