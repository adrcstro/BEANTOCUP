        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<tr>
                        <td><img style="border-radius: 10px;" src="uploads/' . $row["Orderimage"] . '" alt="Item Image" width="100"></td>
                        <td>' . $row["orderid"] . '</td>
                        <td><input type="text" value="' . $row["ItemsOrdered"] . '" class="items-ordered"></td>
                        <td><input type="text" value="' . $row["Size"] . '" class="size"></td>
                        <td><input type="text" value="' . $row["QTY"] . '" class="quantity"></td>
                        <td><input type="text" value="' . $row["Amount"] . '" class="amount"></td>
                    </tr>';
...
<!-- JavaScript to populate input fields -->
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Add JavaScript code here to fetch and populate input fields dynamically
        // You may use AJAX to fetch data from the server or any other method as per your requirements
    });
</script>
