    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<tr>
                        <td colspan="2"></td>
                        <td><input type="text" name="itemsOrdered[]" value="' . $row["ItemsOrdered"] . '" required></td>
                        <td><input type="text" name="size[]" value="' . $row["Size"] . '" required></td>
                        <td><input type="text" name="quantity[]" value="' . $row["QTY"] . '" required></td>
            ...
            // Submit button outside the form to avoid duplicate submissions
