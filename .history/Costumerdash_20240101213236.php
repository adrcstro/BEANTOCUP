...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Add input fields for ItemsOrdered, Size, QTY, and Total Amount
            echo '<div>
                    <label for="newItemsOrdered">Items Ordered:</label>
                    <input type="text" id="newItemsOrdered" name="newItemsOrdered" placeholder="Caramel Macchiato, Hazelnut Heaven">
                </div>
                <div>
                    <label for="newSize">Size:</label>
                    <input type="text" id="newSize" name="newSize" placeholder="Medium, Large">
                </div>
                <div>
                    <label for="newQty">Quantity:</label>
                    <input type="text" id="newQty" name="newQty" placeholder="2, 2">
                </div>
                <div>
