...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    echo '<div>
            ...
            <input type="text" id="newItemsOrdered" name="newItemsOrdered" value="' . $itemsOrderedData . '">
          </div>
          <div>
            <label for="newSize">Size:</label>
            <input type="text" id="newSize" name="newSize" value="' . $sizeData . '">
          </div>
          <div>
            <label for="newQty">Quantity:</label>
            <input type="text" id="newQty" name="newQty" value="' . $qtyData . '">
          </div>
          <div>
