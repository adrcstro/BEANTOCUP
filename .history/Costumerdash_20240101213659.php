...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    // Retrieve data for input fields
    $itemsOrderedData = implode(', ', array_column($result->fetch_all(MYSQLI_ASSOC), 'ItemsOrdered'));
    $sizeData = implode(', ', array_column($result->fetch_all(MYSQLI_ASSOC), 'Size'));
    $qtyData = implode(', ', array_column($result->fetch_all(MYSQLI_ASSOC), 'QTY'));

    // Display input fields with retrieved data
    echo '<div>
            <label for="newItemsOrdered">Items Ordered:</label>
            <input type="text" id="newItemsOrdered" name="newItemsOrdered" value="' . htmlspecialchars($itemsOrderedData) . '">
          </div>
          <div>
            <label for="newSize">Size:</label>
            <input type="text" id="newSize" name="newSize" value="' . htmlspecialchars($sizeData) . '">
          </div>
          <div>
            <label for="newQty">Quantity:</label>
            <input type="text" id="newQty" name="newQty" value="' . htmlspecialchars($qtyData) . '">
          </div>
          <div>
