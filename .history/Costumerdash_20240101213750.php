...
if ($loggedInCostumerID !== null && $loggedInUsername !== null) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            cho '<table class="table table-hover table-nowrap">
    ...
    // Display the retrieved data outside input fields
    echo '<div>
            <label>Items Ordered:</label> ' . htmlspecialchars($itemsOrderedData) . '
          </div>
          <div>
            <label>Size:</label> ' . htmlspecialchars($sizeData) . '
          </div>
          <div>
            <label>Quantity:</label> ' . htmlspecialchars($qtyData) . '
          </div>
          <div>
