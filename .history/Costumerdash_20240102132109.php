...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<p class="card-text">' . $trimmed_body . ' <a href="#" class="read-more" data-toggle="modal" data-target="#searchMenureadMoreModal' . $row['MenuID'] . '">Read More</a></p>';
      ...
      // Added custom class btn-sm-custom
       ...
       echo '<button data-toggle="modal" data-target="#BuyNow" class="btn btn-sm-custom mr-1 buy-now-btn" data-id="' . $MEnuID . '" onclick="hideInputFields()"> <i class="fas fa-shopping-bag"></i> Order Now</button>';
        ...
        // Modal for full text
        echo '<div  class="modal fade" id="searchMenureadMoreModal' . $row['MenuID'] . '" tabindex="-1" role="dialog" aria-labelledby="readMoreModalLabel' . $row['MenuID'] . '" aria-hidden="true">';
