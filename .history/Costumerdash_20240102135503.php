...
<div class="menu-btns">
    <button type="button" class="menu-btn" data-toggle="modal" data-target="#hotcoffees" id="featured">
        <img src="path/to/hot-coffee-icon.png" alt="Hot Coffee" style="width: 16px; height: 16px;"> Hot Coffee's
    </button>
    <button type="button" class="menu-btn" data-toggle="modal" data-target="#Pastries" id="today-special">
        <img src="Images/hotcoffee1.jpg" alt="Pastries" style="width: 16px; height: 16px;"> Pastries
    </button>
    <button type="button" class="menu-btn" data-toggle="modal" data-target="#IceCoffees" id="new-arrival">
        <img src="path/to/ice-coffee-icon.png" alt="Ice Coffee" style="width: 16px; height: 16px;"> Ice Coffee's
    </button>
    <button type="button" class="menu-btn" data-toggle="modal" data-target="#BlendedCoffees" id="Blended-Coffee">
        <img src="path/to/blended-coffee-icon.png" alt="Blended Coffee" style="width: 16px; height: 16px;"> Blended Coffee's
    </button>
    <button type="button" class="menu-btn" data-toggle="modal" data-target="#hotteas" id="Hot-tea">
        <img src="path/to/hot-tea-icon.png" alt="Hot Tea" style="width: 16px; height: 16px;"> Hot Tea's
    </button>
</div>
