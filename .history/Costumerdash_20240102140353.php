...
<div class="menu-btns">
    <button type="button" class="menu-btn" data-toggle="modal"  data-target="#hotcoffees" id="featured"><i class="fas fa-coffee"></i>Hot Coffee's</button>
    <button type="button" class="menu-btn" data-toggle="modal"  data-target="#Pastries" id="today-special"><i class="fas fa-birthday-cake"></i>Pastries</button>
    <button type="button" class="menu-btn" data-toggle="modal"  data-target="#IceCoffees" id="new-arrival"><i class="fas fa-ice-cream"></i>Ice Coffee's</button>
    <button type="button" class="menu-btn" data-toggle="modal"  data-target="#BlendedCoffees" id="Blended-Coffee"><i class="fas fa-blender"></i>Blended Coffee's</button>
    <button type="button" class="menu-btn" data-toggle="modal"  data-target="#hotteas" id="Hot-tea"><i class="fas fa-mug-hot"></i>Hot Tea's</button>
</div>
