    ...
    <div class="modal-dialog">
        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <div class="modal-body">
                <form id="Delete" action="trackdelete.php" method="post">
                    <div class="form-group">
                        <label for="Costuorderid">Print Selected Reciept</label>
                        <select name="Costuorderid" id="Costuorderid" class="form-control" required>
                            <option value="" disabled selected>Select Order ID </option>
                    ...
                    <div class="modal-footer">
                        <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close
                        <i class="bi bi-close"></i> Print
                    </button>
                        <button style="background-color: #E48F45; color: #fff;" id="Cosorderdelte" type="submit" class="btn btn">
