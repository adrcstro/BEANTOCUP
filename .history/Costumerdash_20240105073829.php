        ...
        <div style="background-color: #E48F45;" class="modal-header">
            ...
            <div class="modal-body">
                <form id="reciptorder" action="generaterecipt.php" method="post"  enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="Cosreceipt">Print Selected Reciept</label>
                        
    <input type="text" name="Cosreceipt" id="Cosreceipt" class="form-control" placeholder="Type Any of These Details to Know the Driver: Name/VehicleNumber/PlateNumber" required>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const searchInput = document.getElementById("Cosreceipt");
        const searchResults = document.getElementById("OrderResult");

        searchInput.addEventListener("input", function() {
            const searchText = searchInput.value.toLowerCase();
            if (searchText.length > 0) {
                fetch(`CostumerOrderdetails.php?search=${searchText}`)
