...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button style="background-color: #E48F45; color: #fff;" id="trackorderUpdate" type="submit" class="btn btn">Update Details</button>
                </div>
    ...
    <script>
  $(document).ready(function() {
    $("#trackorderUpdate").submit(function() {
...
<div class="modal fade" id="cancelorder">
    ...
    ?>
                    ...
                    <div class="modal-footer">
                        <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                        <button style="background-color: #E48F45; color: #fff;" id="Cosorderdelte" type="button" class="btn btn">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    document.getElementById('printreceipt').addEventListener('click', function() {
        ...
        if (newTab) {
            ...
            var clonedForm = document.getElementById('reciptorder').cloneNode(true);
