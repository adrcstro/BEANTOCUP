...
<div class="modal fade" id="onlinescan">
  ...
  <div class="card shadow uniwqe" style="width: 250px; margin-right: 20px;">
    <img src="../Images/Gcash.jpg" class="card-img-top" alt="Card Image">
    <div class="card-body mt-3">
      <div class="text-center mt-2">
        <h5 class="card-title mb-1">G-Cash</h5>
        <p class="card-text mt-2">Process Unclaim Orders from Different Customers</p>
      </div>
  ...
  <div class="card shadow uniwqe" style="width: 250px; margin-left: 20px;">
