...
<div class="modal fade" id="onlinescan">
  ...
  <div style="width: 300px; margin-right: 20px; position: relative;" class="card shadow uniwqe">
    <img src="../Images/Gcash.jpg" style="width: 100%;" alt="Card Image">
    <div style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); padding: 20px; background-color: white; width: 100%;" class="card-body">
      <div style="text-align: center;">
        <h5 style="margin-bottom: 10px;">G-Cash</h5>
        <p>We accept G-cash Payment, just scan the Qr-Code and give it to the rider as a Prof</p>
      </div>
      <div style="text-align: center; margin-top: 10px;">
        <a href="#" style="text-decoration: none; padding: 5px 10px; border: 1px solid #ccc;">Select</a>
      </div>
    </div>
  </div>

  <div style="width: 300px; margin-left: 20px; position: relative;" class="card shadow uniwqe">
    <img src="../Images/maya.jpg" style="width: 100%;" alt="Card Image">
    <div style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); padding: 20px; background-color: white; width: 100%;" class="card-body">
      <div style="text-align: center;">
        <h5 style="margin-bottom: 10px;">Maya</h5>
        <p>We accept Maya Payment, just scan the Qr-Code and give it to the rider as a Prof</p>
      </div>
      <div style="text-align: center; margin-top: 10px;">
        <a href="#" style="text-decoration: none; padding: 5px 10px; border: 1px solid #ccc;">Select</a>
      </div>
