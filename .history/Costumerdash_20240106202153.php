...
<div class="modal fade" id="onlinescan">
  ...
  <div class="card shadow uniwqe" style="width: 300px; margin-right: 20px;">
  ...
  <div class="card shadow uniwqe" style="width: 300px; margin-left: 20px;">
    <img src="../Images/maya.jpg" class="card-img-top" alt="Card Image">
    <div class="card-body mt-3"> <!-- Changed from mt-7 to mt-3 for consistency -->
      <div class="text-center mt-2">
        <h5 class="card-title mb-1">Maya</h5>
        <p class="card-text mt-2">We accept Maya Payment just scan the Qr-Code and Give it to the rider as a Prof of payment </p>
      </div>
      <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
        <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
