  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow uniwqe">
        ...
        <div class="card-body">
          <div class="text-center">
            <h5 class="card-title mt-2 mb-1">Maya</h5>
            <p class="card-text mt-2">We accept Maya Payment just scan the Qr-Code and Give it to the rider as a Prof of payment to Confirm</p>
          </div>
          <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
            <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
