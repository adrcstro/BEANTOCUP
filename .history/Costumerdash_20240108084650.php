...
<div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document"> <!-- Updated modal-lg for a wider modal -->
        <div class="modal-content">
            <div style="background-color: #E48F45;" class="modal-header">
            ...
            <div class="modal-body">
                <div class="timeline">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-dark" role="progressbar" style="width: 35%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="timeline-item">
                ...
                <p class="mt-3 text-center" id="statusContent"></p> <!-- Added mt-3 for top margin and text-center for centering -->
            </div>
        </div>
    </div>
</div>';
 ...
 <script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            $('#statusContent').text('Order Status: ' + status);
        });
    });
</script>
