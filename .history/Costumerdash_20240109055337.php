    ...
    <div id="statussection" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="progress">
                    <div class="progress-bar bg-dark" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                        <div class="timeline-item">
                ...
                <div class="progress">
                    <div class="progress-bar bg-dark" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        <div class="timeline-item">
                ...
                <p class="mt-3 text-center" id="statusContent"></p>
            </div>
        </div>
    </div>
</div>
