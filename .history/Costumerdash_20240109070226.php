 ...
 <script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            // Check if progress bar has a value of 10 and apply styles to timeline item container
            if (parseInt(progressBar.attr('aria-valuenow')) === 10) {
                $('.timeline-item-container').css({
                    'background-color': '#994D1C',
                    'color': '#fff'
                });
            } else {
                // Reset styles if progress bar value is not 10
                $('.timeline-item-container').css({
                    'background-color': '',
                    'color': ''
                });
