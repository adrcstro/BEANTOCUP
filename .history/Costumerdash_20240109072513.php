            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div id="ordereed" class="timeline-item-container mb-2">
 ...
 <script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            if (statusContentValue === 'none') {
                // Change background and font color of the specified containers
                $('.col-12.col-md-6.col-lg-3 .timeline-item-container').css({
                    'background-color': '#yourNewBackgroundColor',
                    'color': '#yourNewFontColor'
                });
            } else {
