...
?>
 ...
 <script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            switch (status) {
                ...
                case 'Delivered':
                    ...
                    addCheckIcon('none');
                    addCheckIcon('inprocess');
                    addCheckIcon('intransit');
                    break;
                default:
                    setProgressBarWidth(progressBar, 10);
                    // Reset box colors and remove check icons if status is not recognized
                    resetBoxColors();
                    removeCheckIcons();
            }
        });
        ...
        function addCheckIcon(boxId) {
            // Append a check icon to the specified box
            $('#' + boxId + ' .timeline-item').append('<i class="fas fa-check"></i>');
        }

        function removeCheckIcons() {
            // Remove all check icons from the timeline items
            $('.timeline-item i.fa-check').remove();
        }
