            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="checkOrdered" class="check-icon"></div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="checkOrderProcess" class="check-icon"></div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="checkIntransit" class="check-icon"></div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="checkDelivered" class="check-icon"></div>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        function showCheckIcon(iconId) {
            // Hide all check icons
            $('.check-icon').hide();

            // Show the specific check icon
            $('#' + iconId).show();
        }
