        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="none" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status status-button" data-status="Ordered">Ordered</span>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="inprocess" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status status-button" data-status="Order Process"> On Process</span>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="intransit" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status status-button" data-status="Intransit">In Transit</span>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div id="delivered" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status status-button" data-status="Delivered">Delivered</span>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <!-- Check icons for each status initially hidden -->
                    <img src="Images/check-icon.png" alt="Check Icon" class="check-icon" style="display:none;" id="check-icon-inprocess">
                    <img src="Images/check-icon.png" alt="Check Icon" class="check-icon" style="display:none;" id="check-icon-intransit">
                    <img src="Images/check-icon.png" alt="Check Icon" class="check-icon" style="display:none;" id="check-icon-delivered">
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            switch (status) {
                ...
                case 'Delivered':
                    ...
                    // Show check icon when Delivered status is reached
                    showCheckIcon();
                    break;
                default:
        ...
        function showCheckIcon(status) {
            // Display the check icon for the specified status
            $('#check-icon-' + status).show();
        }
