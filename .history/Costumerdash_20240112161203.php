...
<script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            switch (status) {
                case 'Ordered':
                    setProgressBarWidth(progressBar, 25);
                    showCheck('check-ordered');
                    break;
                case 'On Process':
                    setProgressBarWidth(progressBar, 50);
                    showCheck('check-inprocess');
                    break;
                case 'In Transit':
                    setProgressBarWidth(progressBar, 75);
                    showCheck('check-intransit');
                    break;
                case 'Delivered':
                    setProgressBarWidth(progressBar, 100);
                    showCheck('check-delivered');
                    break;
                default:
