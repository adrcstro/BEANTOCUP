...
<div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel" aria-hidden="true">
    <div id="statussection" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
    <!-- Display check icon for Ordered if status is Empty or None -->
    <div class="col-3 text-center" style="display: {% if status in ['Empty', 'None'] %}block{% else %}none{% endif %};">
    ...
    <!-- Display check icons for Ordered and On Process if status is 'Order Process' -->
    <div class="col-3 text-center" style="display: {% if status == 'Order Process' %}block{% else %}none{% endif %};">
        <div class="completed-circle">
            <i class="fas fa-check"></i>
        </div>
        <p>Ordered</p>
    ...
    <!-- Display check icons for Ordered, On Process, and In Transit if status is 'Intransit' -->
    <div class="col-3 text-center" style="display: {% if status == 'Intransit' %}block{% else %}none{% endif %};">
        <div class="completed-circle">
            <i class="fas fa-check"></i>
        </div>
        <p>Ordered</p>
    ...
    <!-- Display check icons for Ordered, On Process, In Transit, and Delivered if status is 'Delivered' -->
    <div class="col-3 text-center" style="display: {% if status == 'Delivered' %}block{% else %}none{% endif %};">
        <div class="completed-circle">
            <i class="fas fa-check"></i>
        </div>
        <p>Ordered</p>
