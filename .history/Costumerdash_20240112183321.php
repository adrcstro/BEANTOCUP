    ...
    $('.status-button').click(function () {
        ...
        switch (status) {
            ...
            default:
                ...
                // Reset check icons if status is not recognized
                resetCheckIcons();
        }
    });

    function showCheckIcons(statusList) {
        // Hide all check icons
        resetCheckIcons();

        // Show check icons for specified statuses
        for (var i = 0; i < statusList.length; i++) {
            $('[data-status="' + statusList[i] + '"] .completed-circle').show();
        }
    }
