            ...
            <div class="modal-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div id="none" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status-button" data-status="Ordered">Ordered</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div id="inprocess" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status-button" data-status="On Process"> On Process</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div id="intransit" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status-button" data-status="In Transit">In Transit</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div id="delivered" class="timeline-item-container mb-2">
                            <div class="timeline-item text-center">
                                ...
                                <span class="status-button" data-status="Delivered">Delivered</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-3 text-center">
                        <div id="check-ordered" class="completed-circle" style="display: none;">
                            <i class="fas fa-check"></i>
                        </div>
                        <p>Ordered</p>
                    </div>
                    <div class="col-3 text-center">
                        <div id="check-inprocess" class="completed-circle" style="display: none;">
                            <i class="fas fa-check"></i>
                        </div>
                        <p>On Process</p>
                    </div>
                    <div class="col-3 text-center">
                        <div id="check-intransit" class="completed-circle" style="display: none;">
                            <i class="fas fa-check"></i>
                        </div>
                        <p>In Transit</p>
                    </div>
                    <div class="col-3 text-center">
                        <div id="check-delivered" class="completed-circle" style="display: none;">
                            <i class="fas fa-check"></i>
                        </div>
                        <p>Delivered</p>
                    </div>
...
<script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            // Show only the relevant checkmark based on the status
            showCheckmarks(status);
        });
        ...
        function showCheckmarks(status) {
            // Hide all checkmarks
            $('.completed-circle').hide();

            // Show the relevant checkmark based on the status
            switch (status) {
                case 'Order Process':
                    $('#ordered-check').show();
                    break;
                case 'Intransit':
                    $('#ordered-check, #inprocess-check').show();
                    break;
                case 'Delivered':
                    $('#ordered-check, #inprocess-check, #intransit-check').show();
                    break;
                default:
                    $('#ordered-check').show(); // Show "Ordered" check by default
            }
        }
    });
</script>
