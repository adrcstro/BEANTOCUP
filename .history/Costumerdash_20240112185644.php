    ...
    <div id="statussection" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                <div class="col-3 text-center" id="orderedCheck">
                    <div class="completed-circle">
                        <i class="fas fa-check" style="display: none;"></i>
                    </div>
                    <p><i class="fas fa-check" style="margin-bottom: 5px;"></i> Ordered</p>
                </div>
                <div class="col-3 text-center" id="onProcessCheck" style="display: none;">
                    <div class="completed-circle">
                        <i class="fas fa-check" style="display: none;"></i>
                    </div>
                    <p><i class="fas fa-check" style="margin-bottom: 5px;"></i> On Process</p>
                </div>
                <div class="col-3 text-center" id="inTransitCheck" style="display: none;">
                    <div class="completed-circle">
                        <i class="fas fa-check" style="display: none;"></i>
                    </div>
                    <p><i class="fas fa-check" style="margin-bottom: 5px;"></i> In Transit</p>
                </div>
                <div class="col-3 text-center" id="deliveredCheck" style="display: none;">
                    <div class="completed-circle">
                        <i class="fas fa-check" style="display: none;"></i>
                    </div>
                    <p><i class="fas fa-check" style="margin-bottom: 5px;"></i> Delivered</p>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            // Reset all check icons to hide them
            ...
            switch (status) {
                ...
                case 'Delivered':
                    ...
                    break;
                default:
                    // Reset if status is not recognized
