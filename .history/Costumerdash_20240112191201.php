    ...
    <div id="statussection" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                <div class="col-3 text-center" id="ordered">
    ...
    $(document).ready(function () {
        $('.status-button').click(function () {
            ...
            switch (status) {
                case '':
                case 'None':
                    $('#onProcessCheck i').show();
                    break;
                case 'Order Process i':
                    $('#onProcessCheck i').show();
                    break;
                case 'Intransit':
                    $('#onProcessCheck i').show();
                    $('#inTransitCheck i').show();
                    $('#inTransitCheck i').show(); // Show check icon for 'In Transit'
                    break;
                case 'Delivered':
                    $('#onProcessCheck i').show();
                    $('#inTransitCheck i').show();
                    $('#deliveredCheck i').show();
                    $('#deliveredCheck i').show(); // Show check icon for 'Delivered'
                    break;
                default:
