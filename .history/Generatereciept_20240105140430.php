...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent .= "Complaint ID: " . $row['DatePlaced'] . ". ";
            $letterContent .= "Complaint ID: " . $row['ShippingAddress'] . ". ";
            $letterContent .= "Complaint ID: " . $row['ContactNumber'] . ". ";
            $letterContent .= "Complaint ID: " . $row['EmailAddress'] . ". ";
            $letterContent .= "Complaint ID: " . $row['PaymentMethod'] . ". ";
            $letterContent .= "Complaint ID: " . $row['ItemsOrdered'] . ". ";
            $letterContent .= "Complaint ID: " . $row['Size'] . ". ";
            $letterContent .= "Complaint ID: " . $row['QTY'] . ". ";
            $letterContent .= "Complaint ID: " . $row['Amount'] . ". ";
