...
// Loop through each label and data, adding them to the table
for ($i = 0; $i < count($labels); $i++) {
    // Add label in the first column of the first row
    $pdf->Cell($cellWidth, 10, $labels[$i], 1, 0, 'L');

    // Add corresponding data in the second column of the first row
    $pdf->Cell($cellWidth, 10, $data[$i], 1, 1, 'L');
}

// Add extra line spacing after the first row
$pdf->Ln(5);
