...
$columnWidths = array(50, 50, 30, 40, 30);
...
for ($i = 0; $i < count($headers); $i++) {
    ...
    // Add cell with specified width and content
    $pdf->Cell($columnWidths[$i], $cellHeight, $headers[$i], 0, 0, 'L');
}
...
for ($i = 0; $i < count($data); $i++) {
    ...
    // Add cell with specified width and content
    $pdf->Cell($columnWidths[$i], $cellHeight, $data[$i], 0, 0, 'L');
}
