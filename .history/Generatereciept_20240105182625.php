...
foreach ($data as $header => $value) {
    ...
    $pdf->Cell($columnWidths[0], $cellHeight, $header, '1', 0, 'L');
    $pdf->MultiCell($columnWidths[1], $cellHeight, $value, '1', 'L');
}
...
$pdf->Ln(10); // You can adjust the value (e.g., 10) based on your layout requirements
