...
$organizationAddress = "Your New Address";
$organizationContactNumber = "Your Contact Number";
...
class PDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        // Display organization address and contact number on the same row with a vertical line
        $this->Ln(-4); // Adjust the line spacing as needed
        $this->Cell(90, 10, $this->organizationAddress, 0, 0, 'C'); // Adjust the width as needed
        $this->Cell(10, 10, '|', 0, 0, 'C'); // Vertical line separator
        $this->Cell(90, 10, 'Contact Number: ' . $this->organizationContactNumber, 0, 1, 'C'); // Adjust the width as needed
