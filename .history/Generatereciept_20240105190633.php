    ...
    if (isset($_POST["Cosreceipt"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $columnWidths = array(65, 35, 20, 30);

                // First-row headers
                $headers = array('Items Ordered', 'Size', 'Quantity', 'Payment Method');
                ...
                $pdf->SetFont('times', '', 12);
                $pdf->Cell(0, 10, 'Payment Method: ' . $row['PaymentMethod'], 0, 1, 'L');
                $pdf->Cell(0, 10, 'Amount: ' . $row['Amount'], 0, 1, 'L');
            }
