...
for ($i = 0; $i < count($data); $i++) {
    ...
    // Add cell with specified width, height, content, and border
    $pdf->MultiCell($columnWidths[$i], $cellHeight, $data[$i], '1', 'T'); // Set vertical alignment to 'T' (Top)
}
...
// Display Payment Details, Method, and Amount in a single row
$pdf->SetFont('times', 'B', 12);
$pdf->Cell(0, 10, 'Payment Details: ' . $row['PaymentMethod'], 0, 0, 'L'); // Display Payment Method
