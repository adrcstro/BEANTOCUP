...
// You can adjust this value as needed
                ...
                $cellHeight = 10; // or any other value that suits your design
...
for ($i = 0; $i < count($data); $i++) {
    $orderDetails = "{$row['ItemsOrdered']} | Size: {$row['Size']} | Quantity: {$row['QTY']}";

    $pdf->Cell(array_sum($columnWidths), $cellHeight, $orderDetails, '1', 1, 'C');
