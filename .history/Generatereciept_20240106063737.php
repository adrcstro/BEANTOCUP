...
for ($i = 0; $i < count($headers); $i++) {
    ...
    $fontSize = calculateFontSize($pdf, $headers[$i], $columnWidths[$i], $maxFontSize);
    $pdf->SetFont('times', '', $fontSize);
...
for ($i = 0; $i < count($data); $i++) {
    ...
    // Set font size based on text length
    $fontSize = calculateFontSize($pdf, $data[$i], $columnWidths[$i], $maxFontSize);
    $pdf->SetFont('times', '', $fontSize);
