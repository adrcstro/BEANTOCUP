...
// Concatenate data into a single string with spaces
$dataRow = implode('   ', $data); // You can adjust the number of spaces as needed

// Add multi-cell with specified width, height, content, and border
$pdf->MultiCell(array_sum($columnWidths), $cellHeight, $dataRow, '1', 'C');
