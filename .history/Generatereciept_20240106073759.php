...
// Set the height for a single line
$singleLineHeight = 10;
...
// Add a MultiCell for the entire row with a single line height
$pdf->MultiCell(array_sum($columnWidths), $singleLineHeight, $rowData, '1', 'C');
