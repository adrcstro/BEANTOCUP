...
// Add cells with specified width, content, and border
...
// Note: Adjust $y if you want to move to a new line after this row
...
// Display Payment Details, Method, and Amount in a single row
$pdf->SetFont('times', 'B', 12);
$pdf->Cell(0, -100, 'Payment Method: ' . $row['PaymentMethod'], 0, 0, 'L'); // Display Payment Method
