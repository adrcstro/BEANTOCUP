...
class PDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->Cell(0, 20, $this->organizationName, 0, 1, 'C');

        // Center organization address and contact number on the same row with a vertical line
        $this->Ln(-40); // Adjust the line spacing as needed
        $this->Cell(0, 30, $this->organizationAddress . ' | Contact Number: ' . $this->organizationContactNumber, 0, 1, 'C');
    ...
    public function Footer()
    {
        ...
        $this->SetFont('times', 'BI', 12); // Set font to bold and italic
