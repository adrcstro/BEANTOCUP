...
<nav class="navbar navbar-expand-lg navbar-light  bg-white shadow">
    <div class="container">
      <a class="navbar-brand" href="#">BEAN TO CUP<i style="margin-left: 10px; color: #E48F45;   " class="fas fa-mug-hot" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" onclick="showBlogs()" >BLOGS</a>
          </li>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item text-center bg-cover vh-100 active slide-1" data-bs-interval="3000">
        ...
        <div class="row justify-content-center">
            ...
            <a href="#" style="margin-top: 10px;" class="btn btn-brand">EXPLORE</a>
            <a href="#" style="margin-top: 10px;" class="btn btn-secondary">ORDER</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="carousel-item text-center bg-cover vh-100 slide-2 " data-bs-interval="2000">
        ...
        <div class="row justify-content-center">
            ...
            <h6 class="text-white">"Indulge in the rich, aromatic embrace of our handcrafted coffee blends, meticulously curated to awaken your senses and elevate your daily brew. Experience the perfect harmony of robust flavors and smooth textures, delivering an unparalleled coffee journey that transcends ordinary sips."</h6>
            <a href="#" style="margin-top: 10px;" class="btn btn-brand">EXPLORE</a>
            <a href="#" style="margin-top: 10px;" class="btn btn-secondary" id="transbtn">ORDER</a>
        </div>
        </div>
      </div>
    </div>
...
<p>Welcome to "Bean to Cup," a haven for discerning coffee enthusiasts. Here at Bean to Cup, 
  ...
  <a href="https://www.philatlas.com/luzon/ncr/manila/barangay-409.html" target="_blank" style="background-color: #E48F45;" class="read-more">Read More</a>
</div>
</section>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 mb-4">
        <div class="card">
          <img src="Images/blog7.jpg" alt="" class="card-img-top custom-card-img">
          <div class="card-body">
            <h5 class="card-title"> "Exploring Exotic Coffee Beans: A Journey from Crop to Cup"</h5>
            <p class="card-text">Embark on a flavorful adventure as we delve into the origins of exotic coffee beans. From the lush hills of Ethiopia to the vibrant plantations of Colombia, discover the unique characteristics that make each bean special. </p>
            <button class="btn btn-brand" type="button" name="login">Read</button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 mb-4">
        <div class="card">
          <img src="Images/blog5.jpg" alt="" class="card-img-top custom-card-img">
          <div class="card-body">
            <h5 class="card-title">"The Art of Brewing: Elevate Your Coffee Game with Creative Techniques"</h5>
            <p class="card-text">Unleash your inner barista with our guide to creative coffee brewing techniques. From pour-over perfection to mastering the art of latte art, we'll take you step by step through innovative methods to elevate your at-home coffee experience. </p>
            <button class="btn btn-brand" type="button" name="login">Read</button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 mb-4">
        <div class="card">
          <img src="Images/blog6.jpg" alt="" class="card-img-top custom-card-img">
          <div class="card-body">
            <h5 class="card-title">"Coffee and Conversation: Creating a Cozy Coffee Shop Vibe at Home"
            </h5>
            <p class="card-text">Recreate the warm ambiance of your favorite coffee shop right in your living room Dive into our tips on creating the perfect cozy coffee nook at home.</p>
            <button class="btn btn-brand" type="button" name="login">Read</button>
          </div>
        </div>
      </div>
    ...
    <div class="d-flex flex-wrap" style="margin-top: -2rem; margin-bottom: 2rem;">
      <div class="card mb-3" style="width: 540px;">
          <div class="row g-0">
              <div class="col-md-4">
                  <img src="Images/blog4.jpg" class="img-fluid rounded-start" alt="..." style="height: 300px; object-fit: cover;">
              </div>
              <div class="col-md-8">
                  <div class="card-body d-flex flex-column justify-content-center align-items-center">
                      <h5 class="card-title">"Beyond Espresso: Unraveling the World of Alternative Coffee"</h5>
                      <p class="card-text">Move beyond the traditional espresso and discover a world of alternative coffee delights From the trendy nitro cold brew to the exotic Turkish coffee, we're exploring unique and delicious ways of people. </p>
                      <div class="mt-auto">
                          <button class="btn btn-brand" type="button" name="login">Read</button>
                      </div>
                  </div>
      ...
      <div class="card mb-3" style="width: 540px;">
          <div class="row g-0">
              <div class="col-md-4">
                  <img src="Images/blog9.jpg" class="img-fluid rounded-start" alt="..." style="height: 300px; object-fit: cover;">
              </div>
              <div class="col-md-8">
                  <div class="card-body d-flex flex-column justify-content-center align-items-center">
                      <h5 class="card-title">"The Perfect Pair: Coffee and Desserts for Ultimate Indulgence"</h5>
                      <p class="card-text">Indulge your taste buds as we explore the delightful pairing of coffee and desserts. From classic combinations like coffee and chocolate to more adventurous pairings. Each cup tells a story, crafted with precision.</p>
                      <div class="mt-auto">
                          <button class="btn btn-brand" type="button" name="login">Read</button>
                      </div>
                  </div>
