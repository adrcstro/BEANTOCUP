    ...
    <?php
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '</div>';
                echo '<div class="card-footer text-center bg-transparent">';
                echo '<a href="#" class="read-more-btn btn btn-primary" style="border-top: none;" data-toggle="modal" data-target="#readMoreModal' . $row['NewsID'] . '">Read More  <i class="bi bi-arrow-right-square"></i></a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
