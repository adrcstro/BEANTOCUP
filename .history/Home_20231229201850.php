...
<section  style="display: none;"  id="Contact">
  ...
  <div class="contact-container bg-white custom-shadow mt-n6">
    <div class="form-container">
      ...
      <input type="text" name="Name" id="Name" for="Name" placeholder="Your Name" required>
      <input type="email" name="Email" id="Email" form="Email" placeholder="Enter Your Email..." required>
      <textarea name="Emailcon" id="Emailcon" for="Emailcon" cols="30" rows="10" placeholder="Write Message Here"></textarea>
      <input style="color: #fff;" type="submit" value="Send" class="send-button" id="messegesent">
      </form>
    </div>
<!-- maps-->
<div class="map">
