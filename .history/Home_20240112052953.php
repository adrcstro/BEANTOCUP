...
<nav class="navbar navbar-expand-lg navbar-light  bg-white shadow">
    <div class="container">
      <div class="homelogo"><a style="color: #E48F45;" class="navbar-brand" href="#">BEANtoCUP<i style="margin-left: 10px;" class="fas fa-mug-hot" aria-hidden="true"></i></a></div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8 text-center">
        ...
        <p class="lead">"Sip, savor, and elevate your moments with our expertly crafted coffees"</p>
      </div>
    </div>
    ...
    <div class="row">
        ...
        <div id="aboutCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="img-fluid rounded" src="Images/co1.jpg" alt="Coffee Image 1">
            </div>
            <div class="carousel-item">
              <img class="img-fluid rounded" src="Images/co2.jpg" alt="Coffee Image 2">
            </div>
            <div class="carousel-item">
              <img class="img-fluid rounded" src="Images/co3.jpg" alt="Coffee Image 3">
            </div>
          </div>
      ...
      <div class="col-md-6">
        <h2 class="mb-4">Organic products made with love. That's what you get from us.</h2>
        <p>Welcome to <strong>"Bean to Cup,"</strong> a haven for discerning coffee enthusiasts. Here at Bean to Cup, we're dedicated to the art of bringing you the perfect cup of coffee, starting from the bean and ending with an exquisite sip. Our commitment to excellence is reflected in the carefully curated selection of ethically sourced beans from across the globe.</p>
        <p>Our skilled baristas, true maestros of the coffee craft, artfully brew each cup, ensuring a harmonious blend of flavors and aromas that dance on your palate. Beyond the exceptional coffee, Bean to Cup is a vibrant community space where conversations flow as smoothly as our freshly ground beans, and the cozy atmosphere beckons you to unwind and savor the moment.</p>
        <a href="https://www.facebook.com/beantocupph/" target="_blank" class="btn btn-primary">Read More</a>
      </div>
    </div>
  </div>
</section>
