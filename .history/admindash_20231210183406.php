        ...
        <main class="py-6 bg-surface-secondary">
            <div class="container-fluid">
                ...
                <div  id="Admin-table" class="card shadow border-0 mb-7">
                    <div style="background-color: #E48F45;" class="card-header">
...
<button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn-warning btn-sm m-1" data-toggle="modal" data-target="#update">
    <i class="bi bi-pencil"></i> Update
</button>

<button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn-danger btn-sm m-1" data-toggle="modal"  data-target="#delete">
    <i class="bi bi-trash"></i> Delete
</button>

 <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn-info btn-sm m-1" id="refreshButton">
