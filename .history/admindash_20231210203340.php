...
<!-- Create Admin Modal -->
<div class="modal fade" id="Admin" tabindex="-1" role="dialog" aria-labelledby="adminModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your form fields here for creating a new admin -->
                <form method="post" action="create_admin.php"> <!-- Change the action attribute to the appropriate PHP file handling form submission -->
                    <label for="newAdmin">Admin Name:</label>
                    <input type="text" name="newAdmin" id="newAdmin" required>
