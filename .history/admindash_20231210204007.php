...
<div class="modal-footer">
                    <button style="background-color: #E48F45;" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button style="background-color: #E48F45;" id="Register" type="button" class="btn btn-primary" >Save</button>
                </div>
