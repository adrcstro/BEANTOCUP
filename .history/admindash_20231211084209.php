...
<div class="modal fade" id="update">
    ...
    <div class="input-group">
        <select name="input1" id="input1" class="form-control" style="border-radius: 0;" required>
        ...
        <div class="input-group-append">
            <span class="input-group-text dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="bi bi-chevron-down"></i> <!-- Bootstrap dropdown icon -->
            </span>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?php
                // Fetch options from the database and display them in the dropdown menu
                $conn = new mysqli($servername, $username, $password, $dbname);
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo '<a class="dropdown-item" href="#">'.$row["Admin"].'</a>';
                    }
                } else {
                    echo "0 results";
                }
