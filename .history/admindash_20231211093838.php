...
<script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Update Costumer Information</h4>
    ...
    <div class="form-group">
        <label id="PassengerAge" for="PassengerAge">Email</label>
        <input type="text" name="PassengerAge" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerGender" for="PassengerGender">Phone</label>
        <input name="PassengerGender" type="text" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="PassengerGender" for="PassengerGender">Home Address</label>
        <input name="PassengerGender" type="text" class="form-control" required>
    </div>
</form>
</div>
<div class="modal-footer">
                    ...
                    <button style="background-color: #E48F45; color: #fff;" id="PassengerRegister" type="button" class="btn btn-primary" >Save Costumer</button>
                </div>
