...
<div class="modal fade" id="Editmenu">
        <div  class="modal-dialog">
            <div  class="modal-content">
                ...
                <label for="MenuID">Search News-ID</label>
    ...
    <div class="form-group">
        <label id="HeaderofNews" for="HeaderofNews">Name</label>
        <input name="HeaderofNews" type="Text" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="DateofNews" for="DateofNews">Price</label>
        <input type="date" name="DateofNews" class="form-control" required>
    </div>
    <div class="form-group">
        <label id="Bodytext" for="Bodytext">Body</label>
...
<div class="modal-footer">
                    ...
                    <button style="background-color: #E48F45; color: #fff;" id="NewsUpdate" type="button" class="btn btn-primary">Save News</button>
                </div>
