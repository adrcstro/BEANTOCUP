    ...
    <?php
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="card mb-4 custom-card">';
                echo '<div class="row no-gutters">';
                echo '<div class="col-md-4">';
                echo '<img src="uploads/' . $image . '" class="card-img" alt="Card Image">';
                echo '</div>';
...
<script>
// Your existing script for initializing Bootstrap tooltips
$(function () {
    $('[data-toggle="tooltip"]').tooltip();
});
</script>
<div class="card-footer border-0 py-3 d-flex justify-content-center flex-wrap">
<!-- Your existing card footer content -->
</div>
