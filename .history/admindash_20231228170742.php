...
<script>
    ...
    <div class="container">
       ...
       <div class="form-group">
  <label id="costumerName" for="costumerName">Costumer Name</label>
  <input  class="form-control" type="text"  name="costumerName">
            ...
            <div class="form-group">
                    <label id="addorPAymentmethod" for="addorPAymentmethod">Payment Method</label>
                    <input name="addorPAymentmethod" type="date" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="addorItemsOrdered" for="addorItemsOrdered">Items Ordered</label>
                    <input name="addorItemsOrdered" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label id="addorSize" for="addorSize">Size</label>
                    <input name="addorSize" type="date" class="form-control" required>
                </div>
                <div class="form-group">
    ...
    <div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="SaveItem" type="submit"  class="btn btn-success"><i class="fas fa-save"></i>  Add Order</button>
                </div>
</form>
</div>
            </div>
