...
// Get column names from the "menu" table
...
if ($result->num_rows > 0) {
    ...
    echo "No columns found in the 'menu' table.";
}
...
<div class="form-group">
    ...
    <select name="addorItemsOrdered" class="form-control" required>
        <?php
        // Display the fetched column names as options
        foreach ($columnNames as $columnName) {
            echo '<option value="' . $columnName . '">' . ucfirst($columnName) . '</option>';
        }
        ?>
    </select>
</div>
