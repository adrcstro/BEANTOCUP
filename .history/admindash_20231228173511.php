...
<div class="form-group">
    ...
    <div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="saveorederitem" type="submit"  class="btn btn"><i class="fas fa-save"></i>  Add Order</button>
                </div>
</form>
</div>
            </div>
    ...
    $(document).ready(function(){
        $("#saveorederitem").click(function(){
            ...
            var addorPAymentmethod = $("input[name='addorPAymentmethod']").val();
            var addorItemsOrdered = $("input[name='addorItemsOrderedd']").val();
            var addorSize = $("input[name='addorSizes']").val();
            ...
            $.post("inserttdbs.php",
            {
                ...
                addorPAymentmethod: addorItemsOrdered,
