...
<div class="modal fade" id="editorder">
        ...
        <div class="row">
            <div class="col-md-6">
            <label for="LostItemsID">Search Order-ID</label>
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button style="background-color: #E48F45; color: #fff;" id="lostitemUpdate" type="button" class="btn btn-primary">Save Item</button>
                </div>
