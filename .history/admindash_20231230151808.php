...
<div class="modal fade" id="Orderprocess">
    ...
    <div class="card text-center">
        <img src="path/to/small_image.jpg" class="card-img-top" alt="Small Image">
        <div class="card-body">
            <button type="button" class="btn btn-primary menu-btn" onclick="updateRating('small')">
    ...
    <div class="card text-center">
        <img src="path/to/medium_image.jpg" class="card-img-top" alt="Medium Image">
        <div class="card-body">
            <button type="button" class="btn btn-primary menu-btn" onclick="updateRating('Medium')">
    ...
    <div class="card text-center">
        <img src="path/to/large_image.jpg" class="card-img-top" alt="Large Image">
        <div class="card-body">
            <button type="button" class="btn btn-primary menu-btn" onclick="updateRating('Large')">
