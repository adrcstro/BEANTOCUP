...
<div class="modal fade" id="Orderprocess">
    ...
    <div id="shorcard" class="card shadow uniwqe">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Your order is being Prepared</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1" data-dismiss="modal"
...
<div id="size" style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="PassengerRegister" type="button" class="btn btn">Save Status</button>
                </div>
