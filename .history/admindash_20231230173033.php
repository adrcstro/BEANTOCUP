...
<div id="orderstat" style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
    <label id="orderstat" for="orderstat"></label>
...
<script>
 $(document).ready(function() {
    $("#setstatus").click(function() {
        ...
        var orderstat = $("textarea[name='orderstat']").val();
