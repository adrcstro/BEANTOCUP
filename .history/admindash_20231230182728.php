...
<div style="width: 80%; margin: auto; display:block;  margin-bottom: 10px;">
    ...
    <input class="form-control mx-auto" name="orderstat" id="orderstat" style="width: 100%;">
</div>
...
<div class="modal-footer">
    ...
    <script>
  $(document).ready(function () {
    $("#setstatus").click(async function () {
      var SelectOrderStatus = $("#SelectOrderStatus").val();
      var orderstat = $("input[name='orderstat']").val();
      ...
      try {
        ...
        if (status === 'success') {
          ...
          // Display a SweetAlert with the custom error message
          await Swal.fire({
            title: 'Error!',
            text: message || 'There was an error while updating the record.',
            icon: 'error',
            confirmButtonText: 'Okay',
          });
