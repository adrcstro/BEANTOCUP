...
<script>
    ...
    <div id="shorcard" class="card shadow uniwqe">
        <img src="../Images/onprocess.svg" class="card-img-top" alt="Card Image">
        <div class="card-body">
            <div class="text-center mt-2"> <!-- Added 'mt-2' class for top margin -->
                <h5 class="card-title mb-1">Order on Process</h5> <!-- Added 'mb-1' class for bottom margin -->
                <p class="card-text mt-2">Order is being Prepared</p> <!-- Added 'mt-2' class for top margin -->
            </div>
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
