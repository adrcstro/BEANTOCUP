    ...
    <div id="shorcard" class="card shadow uniwqe">
        ...
        <div class="card-body mt-1"> <!-- Added 'mt-1' class for negative margin -->
            <div class="text-center mt-2">
                <h5 class="card-title mb-1">Process Pending Orders</h5>
                <p class="card-text mt-2">Handle pending orders from various customers</p>
            </div>
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
...
<div class="col-md-4">
    <div id="shorcard" class="card shadow uniwqe">
        ...
        <div class="card-body mt-1"> <!-- Added 'mt-1' class for negative margin -->
            <div class="text-center mt-2">
                <h5 class="card-title mb-1">Handle Delayed Shipments</h5>
                <p class="card-text mt-2">Address delayed shipments and fulfill customer orders promptly</p>
            </div>
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="setstatus" type="button" class="btn btn">Reprocess Status</button>
                </div>
