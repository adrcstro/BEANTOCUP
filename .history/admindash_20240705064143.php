                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        <div style="text-align: center;" class="col-12 mb-4 mb-sm-0"  id="headertextdash">
                            <h1 class="h2 mb-0 ls-tight">BREWBUDDY ORDERING MANAGEMENT</h1>
                        </div>
                        <!-- Actions -->
...
// Query to get the count of rows in the ordertbl table excluding orders with the status Delivered
$sql = "SELECT COUNT(*) AS total FROM ordertbl WHERE status <> 'Delivered'";
$result = $conn->query($sql);
...
?>
            ...
            <div class="mt-2 mb-0 text-sm">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Message</span>
                ...
                <div id="Message-table" style="display:none;" class="card shadow border-0 mb-7">
                    <div class="card-header">
                        <h5 class="mb-0">Message From Different Costumers Experience </h5>
                    </div>
...
<div class="modal fade" id="editnews">
    ...
    <div class="form-group">
        <label id="upnewstime" for="upnewstime">Time</label>
        <input type="time" name="upnewstime" class="form-control" required>
    </div>
...
<div class="modal-footer">
  ...
  $(document).ready(function() {
    $("#NewsUpdate").click(function() {
      ...
      var upnewstime = $("input[name='upnewstime']").val();
...
<div style="display: flex; text-align: center; justify-content:center " class="centerbutton">
...
<button style="background-color: #E48F45; color: #fff;"  type="button" class="btn btn btn-sm m-1" data-toggle="modal" data-target="#Orderprocess">
    <i class="bi bi-plus"></i> Process Order
</button>
...
<div class="modal fade" id="Orderprocess">
        <div class="modal-dialog" id="orderprocessmodal">
            <div class="modal-content">

                <!-- Modal Header -->
                <div style="background-color: #E48F45;" class="modal-header">
                    <h4 style="color: #fff;" class="modal-title">Select Order Status</h4>
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                ...
                <label for="orderId">Select Order ID</label>
                        <select name="orderId" id="orderId" class="form-control" required>
                            <option value="" disabled selected>Select Costumer Order ID</option>
                            <?php
                      ...
                      $sql = "SELECT OrderID FROM ordertbl WHERE Status <> 'Delivered'";
                      $result = $conn->query($sql);
    ...
    <div class="col-md-4">
    <div id="shorcard" class="card shadow uniwqe">
            <img src="../Images/onprocess.svg" class="card-img-top" alt="Card Image">
            <div class="card-body">
                <h5 class="card-title">Order on Process</h5>
                <p class="card-text">Order is being Prepared</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
                    onclick="updateRating('Order Process')">
                        <span class="pe-2">
    ...
    <div class="col-md-4">
    <div id="shorcard" class="card shadow uniwqe">
            <img src="../Images/intransit.svg" class="card-img-top" alt="Card Image">
            <div class="card-body">
                <h5 class="card-title">In Transit</h5>
                <p class="card-text">Your order is Intransit</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
                    onclick="updateRating('Intransit')">
                        <span class="pe-2">
    ...
    <div class="col-md-4">
    <div id="shorcard" class="card shadow uniwqe">
            <img src="../Images/Delivered.svg" class="card-img-top" alt="Card Image">
            <div class="card-body">
                <h5 class="card-title">Delivered</h5>
                <p class="card-text">Your order is Delivered</p>
                <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                    <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
                    onclick="updateRating('Delivered')">
                        <span class="pe-2">
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="setstatus" type="button" class="btn btn">Save Status</button>
                </div>
...
<div  id="OrderHistory" style="display:none;" class="card shadow border-0 mb-7">
                    <div class="card-header">
                        <h5 class="mb-0">Costumers List of Ordered Completely Delivered</h5>
                    </div>
                    <div class="table-responsive">
...
// Fetch data from the ordertbl table with status "Delivered"
$sql = "SELECT * FROM ordertbl WHERE Status = 'Delivered' AND CostumerConfirm != 'Receive'";
$result = $conn->query($sql);
...
<button style="background-color: #E48F45; color: #fff;"  type="button" class="btn btn btn-sm m-1" data-toggle="modal" data-target="#reprocessorder">
    <i class="bi bi-plus"></i> Process Failed Deliver
</button>
...
<button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn btn-sm m-1" id="refreshButton16">
    <i class="bi bi-arrow-clockwise"></i> Refresh
</button>

<script>
        document.getElementById("refreshButton16").addEventListener("click", function() {
            location.reload();
        });
    </script>
    </div>
    ...
    <div class="modal fade" id="reprocessorder">
        <div class="modal-dialog" id="orderprocessmodal">
            <div class="modal-content">

                <!-- Modal Header -->
                <div style="background-color: #E48F45;" class="modal-header">
                    <h4 style="color: #fff;" class="modal-title">Re Process Failed Orders</h4>
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                <form id="updateForm" action="update.php"  method="post">
                <label for="REProcessFailedorder">Select Order ID</label>
                        <select name="REProcessFailedorder" id="REProcessFailedorder" class="form-control" required>
                            <option value="" disabled selected>Select Costumer Order ID</option>
                            <?php
                      ...
                      $sql = "SELECT OrderID FROM ordertbl WHERE Status = 'Delivered' AND CostumerConfirm != 'Receive'";
                      $result = $conn->query($sql);
    ...
    <div id="shorcard" class="card shadow uniwqe">
        <img src="../Images/onprocess.svg" class="card-img-top" alt="Card Image">
        <div class="card-body mt-1"> <!-- Added 'mt-1' class for negative margin -->
            <div class="text-center mt-2">
                <h5 class="card-title mb-1">Order on Process</h5>
                <p class="card-text mt-2">Process Unclaim Orders from Different Costumers</p>
            </div>
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
                    onclick="updatedeliverorderstat('Order Process')">
                    <span class="pe-2">
                        <i class="bi bi-box"></i>
                    </span>
                    <span>Select</span>
...
<div class="col-md-5">
    ...
    <img src="../Images/intransit.svg" class="card-img-top" alt="Card Image">
        <div class="card-body mt-1"> <!-- Added 'mt-1' class for negative margin -->
            <div class="text-center mt-2">
                <h5 class="card-title mb-1">In Transit</h5>
                <p class="card-text mt-2">Process Unclaimed Orders for Delivery Shipment</p>
            </div>
            <div class="shortcutbtn mt-2 d-flex justify-content-center align-items-center">
                <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1"
                onclick="updatedeliverorderstat('Intransit')">
                    <span class="pe-2">
                    <i class="bi bi-bicycle"></i>
                    </span>
                    <span>Select</span>
...
<div style="width: 80%; margin: auto; display:none;  margin-bottom: 10px;">
    <label for="newreStatus"></label>
    <input class="form-control mx-auto" name="newreStatus" id="newreStatus" style="width: 100%;">
</div>

<script>
    function updatedeliverorderstat(rating) {
        document.getElementById("newreStatus").value = rating + "";
        // You can customize this value as per your requirement
    }
</script>
...
<div class="modal-footer">
                    <button style="background-color: #E48F45; color: #fff;" type="button" class="btn btn" data-dismiss="modal">Close</button>
                    <button  style="background-color: #E48F45; color: #fff;" id="restatus" type="button" class="btn btn">Reprocess Status</button>
                </div>
...
<div  id="CompleteTransaction" style="display:none;" class="card shadow border-0 mb-7">
                    <div class="card-header">
                        <h5 class="mb-0">Completed Transaction</h5>
                    </div>
                    <div class="table-responsive">
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        // Check if the status is "Delivered"
        if ($row["CostumerConfirm"] == "Receive") {
            echo '<tr>   
                <td>' . $row["OrderID"] . '</td>
                <td>' . $row["CostumerName"] . '</td>
                <td>' . $row["DatePlaced"] . '</td>
