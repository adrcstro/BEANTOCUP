...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        } elseif (isset($_POST['Costuorderid'])) {
            
            $selectedCostumerorder= $_POST['Costuorderid'];
            $sql = "DELETE FROM ordertbl WHERE OrderID  = ' $selectedCostumerorder'";
            $messageSuccess = 'The Selected Order has been Cancelled.';
        }
        
        elseif (isset($_POST['CosOrderhistory'])) {
            
            $selectedCostumerorder= $_POST['CosOrderhistory'];
            $sql = "DELETE FROM ordertbl WHERE OrderID  = ' $selectedCostumerorder'";
            $messageSuccess = 'The Selected Order has been Deleted.';
        }
