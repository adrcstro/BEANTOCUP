...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['prodname'], $_POST['fullName'], $_POST['email'], $_POST['input3'], $_POST['fullName'], $_POST['email'], $_POST['input3'], $_POST['fullName'], $_POST['email'], $_POST['input3'])) {
    // Collect form data for the second insertion
    ...
    if ($input1 !== null) {
        // Prepare and bind for the second insertion
        $stmt = $conn->prepare("INSERT INTO ordertbl (Admin, Username, DateCreated, Password) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $input1, $input2, $datePicker, $input3);
