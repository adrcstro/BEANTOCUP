...
if (mysqli_num_rows($result) > 0) {
    ...
    // Assign customer ID, username, and user type to session variables
    $_SESSION['CostumerID'] = $row['CostumerID'];
    $_SESSION['username'] = $username;
    $_SESSION['user_type'] = $userType; // Set the user type

    // Set a unique session name for each user
    $secretString = 'c0st0m3rD45h_';  // Change this to any unique string
    session_name($secretString . $username);
