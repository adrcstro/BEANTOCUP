...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($userType == 'admin') {
            header("Location: admindash.php?UserID=$loggedInUserID&username=$loggedInUsername");
        } else {
            header("Location: Costumerdash.php?CostumerID=$loggedInUserID&username=$loggedInUsername");
        }
        exit();
    } else {
