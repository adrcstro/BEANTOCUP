...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Display a Sweet Alert for successful login
        ...
        echo "<script>
            swal({
                ...
                window.location.href = '$dashboard?CostumerID=$loggedInCostumerID&username=$loggedInUsername';
            });
        </script>";
        exit();
    } else {
        ...
        echo "<script src='https://unpkg.com/sweetalert/dist/sweetalert.min.js'></script>";
        echo "<script>
            swal('Invalid Username or Password', '', 'error').then(function() {
