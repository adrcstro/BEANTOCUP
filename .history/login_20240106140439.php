...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<script>swal('Successful Login', '', 'success').then(function() { window.location.href = '$dashboard?CostumerID=$loggedInCostumerID&username=$loggedInUsername'; });</script>";
        exit();
    } else {
        // No matching user found

   
        echo "<script>swal('Invalid Username or Password', '', 'error').then(function() { window.location.href = 'login.php'; });</script>";
