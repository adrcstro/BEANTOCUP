...
if ($result) {
    echo '<div class="row">'; // Start a row container
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<p class="card-text">' . $trimmed_body . ' <a href="#" class="read-more" data-toggle="modal" data-target="#searvhreadMoreModal' . $row['MenuID'] . '">Read More</a></p>';
        ...
        // Modal for full text
        echo '<div class="modal fade" id="searvhreadMoreModal' . $row['MenuID'] . '" tabindex="-1" role="dialog" aria-labelledby="readMoreModalLabel' . $row['MenuID'] . '" aria-hidden="true">';
        echo '<div class="modal-dialog read-more-modal" role="document">';
        echo '<div class="modal-content">';
        echo '<div  style="background-color: #E48F45; color: #fff;" class="modal-header">';
