                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="Phone"  name="Phone" autocomplete="off" type="text" class="form-control" placeholder="Email" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="label" for="name">Home Address</label>
                                <input id="HomeAddress"  name="HomeAddress" autocomplete="off" type="text" class="form-control" placeholder="Email" required>
                            </div>
