                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="Phone"  name="Phone" autocomplete="off" type="text" class="form-control" placeholder="Phone" required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="label" for="name">Home Address</label>
                                <input id="HomeAddress"  name="HomeAddress" autocomplete="off" type="text" class="form-control" placeholder="Home Address" required>
                            </div>
    ...
    $(function(){
      ...
      var Password       = $('#Password').val();
				...
				$.ajax({
					type: 'POST',
					url: 'inserttdbs.php',
				  data:{Name: Name,Email: Email,Phone: Phone,HomeAddress:HomeAddress ,Username:Username,Password: Password},
